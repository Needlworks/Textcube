...
CREATE TABLE {$_POST['dbPrefix']}SkinSettings (
  ...
  NoCommentMessage varchar(35) NOT NULL default 'No comment',
  SingleCommentMessage varchar(35) NOT NULL default 'comment',
  MultipleCommentMessage varchar(35) NOT NULL default 'comments',
  NoTrackbackMessage varchar(35) NOT NULL default 'No trackback',
  SingleTrackbackMessage varchar(35) NOT NULL default 'trackback',
  MultipleTrackbackMessage varchar(35) NOT NULL default 'trackbacks',
