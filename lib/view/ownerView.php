...
function printEntryFileList($attachments, $entryId) {
	...
	<td width="130" valign="top" align="center">
		<div id="previewSelected" style="width:120px; height:90px; background:#FFFFFF"><table width="100%" height="100%"><tr><td valign="middle" align="center"><?php echo _t('미리보기')?></td></tr></table></div>
	</td>
...
?>	
			<script type="text/javascript">
				...
				uploaderStr = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="uploader"'
					...
					+ '<embed id="uploader2" src="<?php echo $service['path']?>/script/uploader/uploader.swf" flashvars="path=<?php echo $blogURL?>&owner=<?php echo $owner?>&entryid=<?php echo $entryId?>&enclosure=<?php echo $enclosureFileName?>&maxSize=<?php echo $maxSize?>&sessionName=TSSESSION&sessionValue=<?php echo $_COOKIE['TSSESSION']?>" width="1" height="1" align="middle" wmode="transparent" quality="high" bgcolor="#ffffff" scale="noScale" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /><\/embed><\/object>';
							...
							<table>
								<tr id="fileUploadNest" >
									<script>
										if(getUploadObj()) {		
											try{
												document.write('<td><input id="uploadBtn" type="button" class="button" value="<?php echo _t('파일 업로드')?>" onclick="browser();" style="margin-top: 1px"/><input id="stopUploadBtn" type="button" class="button" value="<?php echo _t('업로드 중지')?>" onclick="stopUpload();" style="margin-top: 1px; display:none"/></td>');			
											} catch(e) {
	...
	<script type="text/javascript">	
		...
		//if(<?php echo !empty($service['flashuploader']) ? $service['flashuploader'] : 'false'?> ) { 
		 if(!getUploadObj()) {
			...
			<td>
		  		<input type="button" class="button" id="deleteBtn" value="<?php echo _t('삭제하기')?>" onclick="deleteAttachment();" style="margin-top: 1px" />
			</td>
...
<table id="propertyImage1" width="220" border="0" cellpadding="0" cellspacing="1" style="display: none; border: 1px solid #999">
  <tr>
	...
	<span style="font-family:tahoma; font-size:10px; color:#000; font-weight:bold;">Image</span>	  <table width="100%" border="0" cellspacing="0" cellpadding="1" style="margin-top:10px; margin-bottom:10px; table-layout: fixed">
		...
		<col width="50%" />
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('폭')?></td>
		...
		<tr>
		  <td height="1" background="<?php echo $service['path']?>/image/owner/edit/dotted_layer.gif"></td>
		  <td></td>
		</tr>
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('대체 텍스트')?></td>
		...
		<tr>
		  ...
		  <td></td>
						...
						<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('자막')?></td>
...
<table id="propertyObject1" width="220" border="0" cellpadding="0" cellspacing="1" style="display: none; border: 1px solid #999">
  <tr>
	...
	<span style="font-family:tahoma; font-size:10px; color:#000; font-weight:bold;">Object 1</span>	  <table width="100%" border="0" cellspacing="0" cellpadding="1" style="margin-top:10px; margin-bottom:10px; table-layout: fixed">
		...
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('파일명')?></td>
...
<table id="propertyiMazing" width="220" border="0" cellpadding="0" cellspacing="1" style="display: none; border: 1px solid #999">
  <tr>
	...
	<span style="font-family:tahoma; font-size:10px; color:#000; font-weight:bold;">iMazing</span>	  <table width="100%" border="0" cellspacing="0" cellpadding="1" style="margin-top:10px; margin-bottom:10px; table-layout: fixed">
		...
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('높이')?></td>
		...
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('테두리')?></td>
		  <td align="right">
		...
		<tr>
		  ...
		  <td></td>
						...
						<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('장면전환효과')?></td>
		  <td align="right">
		...
		<tr>
		  ...
		  <td></td>
						...
						<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('내비게이션')?></td>
		  <td align="right">
		...
		<tr>
		  ...
		  <td></td>
						...
						<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('슬라이드쇼 간격')?></td>
		...
		<tr>
		  ...
		  <td></td>
						...
						<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('화면당 이미지 수')?></td>
		...
		<tr>
		  ...
		  <td></td>
						...
						<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('정렬방법')?></td>
		  <td align="right">
		...
		<tr>
		  <td><table width="198" height="150" border="0" cellpadding="0" cellspacing="1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				<td height="20" align="right"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/attach_MoveUp.gif" width="40" height="14" alt="<?php echo _t('위로')?>" onclick="editor.moveUpFileList('propertyiMazing_list')"/> <img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/attach_MoveDown.gif" width="50" height="14" alt="<?php echo _t('아래로')?>" onclick="editor.moveDownFileList('propertyiMazing_list')"/></td>
			  </tr>
			</table></td>
		</tr>
	  </table>
...
<table id="propertyGallery" width="220" border="0" cellpadding="0" cellspacing="1" style="display: none; border: 1px solid #999">
  <tr>
	...
	<span style="font-family:tahoma; font-size:10px; color:#000; font-weight:bold;">Gallery</span>	  <table width="100%" border="0" cellspacing="0" cellpadding="1" style="margin-top:10px; margin-bottom:10px; table-layout: fixed">
		...
		<col width="70%" />
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('최대너비')?></td>
		...
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('최대높이')?></td>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px; margin-bottom:10px;">
		<tr>
		  <td><table width="198" height="150" border="0" cellpadding="0" cellspacing="1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				<td height="20" align="right"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/attach_MoveUp.gif" width="40" height="14" alt="<?php echo _t('위로')?>" onclick="editor.moveUpFileList('propertyGallery_list')"/> <img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/attach_MoveDown.gif" width="50" height="14" alt="<?php echo _t('아래로')?>" onclick="editor.moveDownFileList('propertyGallery_list')"/></td>
			  </tr>
			</table></td>
		</tr>
	  </table>
...
<table id="propertyJukebox" width="220" border="0" cellpadding="0" cellspacing="1" style="display: none; border: 1px solid #999">
  <tr>
	...
	<span style="font-family:tahoma; font-size:10px; color:#000; font-weight:bold;">Jukebox</span>	  <table width="100%" border="0" cellspacing="0" cellpadding="1" style="margin-top:10px; margin-bottom:10px; table-layout: fixed">
		...
		<col width="70%" />
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('재생옵션')?></td>
		  <td align="left" style="padding-right:1px;"><input type="checkbox" id="propertyJukebox_autoplay" onclick="editor.setProperty()"/> <label for="propertyJukebox_autoplay"><?php echo _t('자동재생')?></label></td>
		</tr>
		<tr>
		  <td height="1" background="<?php echo $service['path']?>/image/owner/edit/dotted_layer.gif"></td>
		  <td></td>
		...
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('화면표시')?></td>
		  <td align="left" style="padding-right:1px;"><input type="checkbox" id="propertyJukebox_visibility" onclick="editor.setProperty()"/> <label for="propertyJukebox_visibility"><?php echo _t('플레이어보이기')?></label></td>
		</tr>
		<tr>
		  <td height="1" background="<?php echo $service['path']?>/image/owner/edit/dotted_layer.gif"></td>
		  <td></td>
		...
		<tr>
		  <td style="font-size:11px; letter-spacing:-1; color:#666;"><?php echo _t('제목')?></td>
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px; margin-bottom:10px;">
		<tr>
		  <td><table width="198" height="150" border="0" cellpadding="0" cellspacing="1">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				<td height="20" align="right"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/attach_MoveUp.gif" width="40" height="14" alt="<?php echo _t('위로')?>" onclick="editor.moveUpFileList('propertyJukebox_list')"/> <img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/attach_MoveDown.gif" width="50" height="14" alt="<?php echo _t('아래로')?>" onclick="editor.moveDownFileList('propertyJukebox_list')"/></td>
			  </tr>
			</table></td>
		</tr>
	  </table>
...
?>
	...
	<td><img src="<?php echo $service['path']?>/image/owner/edit/dotted_vertical.gif" width="5" height="24" /></td>							
	<td><table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setBold.gif" id="indicatorBold" width="20" height="20" border="0" onclick="TTCommand('Bold')" onmouseover="this.src='<?php echo $service['path']?>/image/owner/edit/setBold_over.gif'" onmouseout="if(!editor.isBold) this.src='<?php echo $service['path']?>/image/owner/edit/setBold.gif'" alt="<?php echo _t('굵게')?>" title="<?php echo _t('굵게')?>"/></td>
		<td><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setItalic.gif" width="20" height="20" border="0" id="indicatorItalic" onclick="TTCommand('Italic')" onmouseover="this.src='<?php echo $service['path']?>/image/owner/edit/setItalic_over.gif'" onmouseout="if(!editor.isItalic) this.src='<?php echo $service['path']?>/image/owner/edit/setItalic.gif'" alt="<?php echo _t('기울임')?>" title="<?php echo _t('기울임')?>"/></td>
		<td><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setUnderLine.gif" width="20" height="20" border="0" id="indicatorUnderline" onclick="TTCommand('Underline')" onmouseover="this.src='<?php echo $service['path']?>/image/owner/edit/setUnderLine_over.gif'" onmouseout="if(!editor.isUnderline) this.src='<?php echo $service['path']?>/image/owner/edit/setUnderLine.gif'" alt="<?php echo _t('밑줄')?>" title="<?php echo _t('밑줄')?>"/></td>
		<td><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setLineThrough.gif" width="20" height="20" border="0" id="indicatorStrike" onclick="TTCommand('StrikeThrough')" onmouseover="this.src='<?php echo $service['path']?>/image/owner/edit/setLineThrough_over.gif'" onmouseout="if(!editor.isStrike) this.src='<?php echo $service['path']?>/image/owner/edit/setLineThrough.gif'" alt="<?php echo _t('취소선')?>" title="<?php echo _t('취소선')?>"/></td>
		<td><a href="#" tabindex="106" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','<?php echo $service['path']?>/image/owner/edit/setColor_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setColor.gif" name="Image6" width="20" height="20" border="0" id="Image6" onclick="hideLayer('markPalette');hideLayer('textBox');toggleLayer('colorPalette')" alt="<?php echo _t('글자색')?>" title="<?php echo _t('글자색')?>"/></a></td>
		<td><a href="#" tabindex="107" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','<?php echo $service['path']?>/image/owner/edit/setMark_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMark.gif" name="Image7" width="20" height="20" border="0" id="Image7" onclick="hideLayer('colorPalette');hideLayer('textBox');toggleLayer('markPalette')" alt="<?php echo _t('배경색')?>" title="<?php echo _t('배경색')?>"/></a></td>
		<td><a href="#" tabindex="108" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','<?php echo $service['path']?>/image/owner/edit/textBox_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/textBox.gif" name="Image8" width="20" height="20" border="0" id="Image8" onclick="hideLayer('markPalette');hideLayer('colorPalette');toggleLayer('textBox')" alt="<?php echo _t('텍스트 상자')?>" title="<?php echo _t('텍스트 상자')?>"/></a></td>
		<td><a href="#" tabindex="109" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','<?php echo $service['path']?>/image/owner/edit/set_remove_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/set_remove.gif" name="Image9" width="20" height="20" border="0" id="Image9" onclick="TTCommand('RemoveFormat')" alt="<?php echo _t('효과 제거')?>" title="<?php echo _t('효과 제거')?>"/></a></td>
	  </tr>
	</table>
	</td>
	<td><img src="<?php echo $service['path']?>/image/owner/edit/dotted_vertical.gif" width="5" height="24" /></td>
	<td><table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setAlignLeft.gif" width="20" height="20" onclick="TTCommand('JustifyLeft')" onmouseover="this.src='<?php echo $service['path']?>/image/owner/edit/setAlignLeft_over.gif'" onmouseout="this.src='<?php echo $service['path']?>/image/owner/edit/setAlignLeft.gif'" alt="<?php echo _t('왼쪽 정렬')?>" title="<?php echo _t('왼쪽 정렬')?>"/></td>
		<td><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setAlignCenter.gif" width="20" height="20" onclick="TTCommand('JustifyCenter')" onmouseover="this.src='<?php echo $service['path']?>/image/owner/edit/setAlignCenter_over.gif'" onmouseout="this.src='<?php echo $service['path']?>/image/owner/edit/setAlignCenter.gif'" alt="<?php echo _t('가운데 정렬')?>" title="<?php echo _t('가운데 정렬')?>"/></td>
		<td><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setAlignRight.gif" width="20" height="20" onclick="TTCommand('JustifyRight')" onmouseover="this.src='<?php echo $service['path']?>/image/owner/edit/setAlignRight_over.gif'" onmouseout="this.src='<?php echo $service['path']?>/image/owner/edit/setAlignRight.gif'" alt="<?php echo _t('오른쪽 정렬')?>" title="<?php echo _t('오른쪽 정렬')?>"/></td>
		<td><a href="#" tabindex="113" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image15','','<?php echo $service['path']?>/image/owner/edit/set_ul_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/set_ul.gif" name="Image15" width="20" height="20" border="0" id="Image15" onclick="TTCommand('InsertUnorderedList')" alt="<?php echo _t('순서없는 리스트')?>" title="<?php echo _t('순서없는 리스트')?>"/></a></td>
		<td><a href="#" tabindex="114" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image16','','<?php echo $service['path']?>/image/owner/edit/set_ol_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/set_ol.gif" name="Image16" width="20" height="20" border="0" id="Image16" onclick="TTCommand('InsertOrderedList')" alt="<?php echo _t('번호 매긴 리스트')?>" title="<?php echo _t('번호 매긴 리스트')?>"/></a></td>
		<td><a href="#" tabindex="115" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','<?php echo $service['path']?>/image/owner/edit/set_outdent_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/set_outdent.gif" name="Image17" width="20" height="20" border="0" id="Image17" onclick="TTCommand('Outdent')" alt="<?php echo _t('내어쓰기')?>" title="<?php echo _t('내어쓰기')?>"/></a></td>
		<td><a href="#" tabindex="116" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image18','','<?php echo $service['path']?>/image/owner/edit/set_indent_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/set_indent.gif" name="Image18" width="20" height="20" border="0" id="Image18" onclick="TTCommand('Indent')" alt="<?php echo _t('들여쓰기')?>" title="<?php echo _t('들여쓰기')?>"/></a></td>
		<td><a href="#" tabindex="117" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image19','','<?php echo $service['path']?>/image/owner/edit/set_blockquote_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/set_blockquote.gif" name="Image19" width="20" height="20" border="0" id="Image19" onclick="TTCommand('Blockquote')" alt="<?php echo _t('인용구')?>" title="<?php echo _t('인용구')?>"/></a></td>
	  </tr>
	</table></td>
	<td><img src="<?php echo $service['path']?>/image/owner/edit/dotted_vertical.gif" width="5" height="24" /></td>
	<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td><a href="#" tabindex="118" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image20','','<?php echo $service['path']?>/image/owner/edit/setCode_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setCode.gif" name="Image20" width="20" height="20" border="0" id="Image20" onclick="TTCommand('CodeBlock')" alt="<?php echo _t('코드')?>" title="<?php echo _t('코드')?>"/></a></td>
		<td><a href="#" tabindex="119" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image21','','<?php echo $service['path']?>/image/owner/edit/setHtml_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setHtml.gif" name="Image21" width="20" height="20" border="0" id="Image21" onclick="TTCommand('HtmlBlock')" alt="<?php echo _t('HTML 코드 직접 쓰기')?>" title="<?php echo _t('HTML 코드 직접 쓰기')?>"/></a></td>
		<td><a href="#" tabindex="120" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image22','','<?php echo $service['path']?>/image/owner/edit/setLink_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setLink.gif" name="Image22" width="20" height="20" border="0" id="Image22" onclick="TTCommand('CreateLink')" alt="<?php echo _t('하이퍼링크')?>" title="<?php echo _t('하이퍼링크')?>"/></a></td>
		<td><a href="#" tabindex="121" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image23','','<?php echo $service['path']?>/image/owner/edit/setEmbed_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setEmbed.gif" name="Image23" width="20" height="20" border="0" id="Image23" onclick="TTCommand('MediaBlock')" alt="<?php echo _t('미디어 삽입')?>" title="<?php echo _t('미디어 삽입')?>"/></a></td>
		<td><a href="#" tabindex="122" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image24','','<?php echo $service['path']?>/image/owner/edit/setFlash_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setFlash.gif" name="Image24" width="20" height="20" border="0" id="Image24" onclick="TTCommand('FlashBlock')" alt="<?php echo _t('플래시 삽입')?>" title="<?php echo _t('플래시 삽입')?>"/></a></td>
		<td><a href="#" tabindex="123" onclick="return false" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image25','','<?php echo $service['path']?>/image/owner/edit/setMoreLess_over.gif',1)"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMoreLess.gif" name="Image25" width="20" height="20" border="0" id="Image25" onclick="TTCommand('MoreLessBlock')" alt="<?php echo _t('More/Less')?>" title="<?php echo _t('More/Less')?>"/></a></td>
	  </tr>
	</table></td>
	<td>&nbsp;</td>
	<td valign="bottom"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/set_switch.gif" width="42" height="11" onclick="TTCommand('ToggleMode')" vspace="3" alt="<?php echo _t('위지윅/텍스트 모드 변경')?>" title="<?php echo _t('위지윅/텍스트 모드 변경')?>"/></td>
  </tr>
</table>
	<div id="colorPalette" style="display:none;margin:4px 0px 4px 10px">
	  <table bgcolor="#FFFFFF" cellspacing="3" style="border-style:solid;border-width:1;border-color:#A0A0A0">
		<tr>
		  <td bgcolor="#008000"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#008000')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#009966"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#009966')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#99CC66"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#99CC66')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#999966"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#999966')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#CC9900"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#CC9900')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#D41A01"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#D41A01')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#FF0000"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#FF0000')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#FF7635"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#FF7635')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#FF9900"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#FF9900')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#FF3399"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#FF3399')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#9B18C1"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#9B18C1')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#993366"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#993366')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#666699"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#666699')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#0000FF"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#0000FF')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#177FCD"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#177FCD')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#006699"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#006699')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#003366"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#003366')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#333333"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#333333')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#000000"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#000000')" width="16" height="16" alt="" /></td>		  
		  <td bgcolor="#8E8E8E"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#8E8E8E')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#C1C1C1"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/spacer.gif" onclick="insertColorTag('#C1C1C1')" width="16" height="16" alt="" /></td>
		</tr>
	  </table>
	</div>
	<div id="markPalette" style="display:none;margin:4px 0px 4px 140px">
	  <table bgcolor="#FFFFFF" cellspacing="3" style="border-style:solid;border-width:1;border-color:#A0A0A0">
		<tr>
		  <td bgcolor="#FFDAED"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="insertMarkTag('#202020', '#FFDAED')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#C9EDFF"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="insertMarkTag('#202020', '#C9EDFF')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#D0FF9D"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="insertMarkTag('#202020', '#D0FF9D')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#FAFFA9"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="insertMarkTag('#202020', '#FAFFA9')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#E4E4E4"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="insertMarkTag('#202020', '#E4E4E4')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#FF0000"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewWhite.gif" onclick="insertMarkTag('#FFFFFF', '#FF0000')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#0000FF"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewWhite.gif" onclick="insertMarkTag('#FFFFFF', '#0000FF')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#009966"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewWhite.gif" onclick="insertMarkTag('#FFFFFF', '#009966')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#670787"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewWhite.gif" onclick="insertMarkTag('#FFFFFF', '#670787')" width="16" height="16" alt="" /></td>
		  <td bgcolor="#333333"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewWhite.gif" onclick="insertMarkTag('#FFFFFF', '#333333')" width="16" height="16" alt="" /></td>
		</tr>
	  </table>
	</div>
	<div id="textBox" style="display:none;margin:4px 0px 4px 200px">
	  <table bgcolor="#FFFFFF" cellspacing="3" style="border-style:solid;border-width:1;border-color:#A0A0A0">
		<tr>
		  <td bgcolor="#FFDAED"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#FFDAED');" width="16" height="16" alt="" /></td>
		  <td bgcolor="#C9EDFF"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#C9EDFF');" width="16" height="16" alt="" /></td>
		  <td bgcolor="#D0FF9D"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#D0FF9D');" width="16" height="16" alt="" /></td>
		  <td bgcolor="#FAFFA9"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#FAFFA9');" width="16" height="16" alt="" /></td>
		  <td bgcolor="#E4E4E4"><img class="pointerCursor" src="<?php echo $service['path']?>/image/owner/edit/setMarkPreviewBlack.gif" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#E4E4E4');" width="16" height="16" alt="" /></td>
		</tr>
	  </table>
	</div>
<?php
...
<table cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="36" height="3" bgcolor="#0468AA"><img src="<?php echo $service['path']?>/image/spacer.gif" width="1" height="1" alt=""></td>
    <td width="*" bgcolor="#4498CF"><img src="<?php echo $service['path']?>/image/spacer.gif" width="1" height="1" alt=""></td>
  </tr>
</table>
<?php
}
