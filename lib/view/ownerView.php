...
?>
													...
													<div id="propertyObject1" class="entry-editor-property" style="display: none;">
														...
														<dl class="line">
															<dt class="property-name"><?php echo _t('파일명')?></dt>
													...
													<div id="propertyiMazing" class="entry-editor-property" style="display: none;">
														...
														<dl class="line">
															<dt class="property-name"><?php echo _t('테두리')?></dt>
															<dd>
														...
														<dl class="line">
															<dt class="property-name"><?php echo _t('장면전환효과')?></dt>
															<dd>
														...
														<dl class="line">
															<dt class="property-name"><?php echo _t('내비게이션')?></dt>
															<dd>
														...
														<dl class="line">
															<dt class="property-name"><?php echo _t('정렬방법')?></dt>
															<dd>
														...
														<dl class="line">
															...
															<dd class="button-box">
																<a href="#void" class="up-button button" onclick="editor.moveUpFileList('propertyiMazing_list')" title="선택한 항목을 위로 이동합니다."><span><?php echo _t('위로')?></span></a>
																<a href="#void" class="dn-button button" onclick="editor.moveDownFileList('propertyiMazing_list')" title="선택한 항목을 아래로 이동합니다."><span><?php echo _t('아래로')?></span></a>
																<div class="clear"></div>
															</dd>
															<dd class="clear"></dd>
														</dl>
													...
													<div id="propertyGallery" class="entry-editor-property" style="display: none;">
														...
														<dl class="line">
															...
															<dd class="button-box">
																<a href="#void" class="up-button button" onclick="editor.moveUpFileList('propertyGallery_list')" title="선택한 항목을 위로 이동합니다."><span><?php echo _t('위로')?></span></a>
																<a href="#void" class="dn-button button" onclick="editor.moveDownFileList('propertyGallery_list')" title="선택한 항목을 아래로 이동합니다."><span><?php echo _t('아래로')?></span></a>
																<div class="clear"></div>
															</dd>
															<dd class="clear"></dd>
														</dl>
													...
													<div id="propertyJukebox" class="entry-editor-property" style="display: none;">
														...
														<dl class="line">
															<dt class="property-name"><?php echo _t('재생옵션')?></dt>
															<dd>
																<input type="text" class="text-input" id="propertyJukebox_autoplay" onkeyup="editor.setProperty()" />
																<label for="propertyJukebox_autoplay"><?php echo _t('자동재생')?></label>
															</dd>
															<dd class="clear"></dd>
														</dl>
														<dl class="line">
															<dt class="property-name"><?php echo _t('화면표시')?></dt>
															<dd>
																<input type="text" class="text-input" id="propertyJukebox_visibility" onkeyup="editor.setProperty()" />
																<label for="propertyJukebox_visibility"><?php echo _t('플레이어보이기')?></label>
															</dd>
															<dd class="clear"></dd>
														</dl>
														<dl class="line">
															<dt class="property-name"><?php echo _t('제목')?></dt>
														...
														<dl class="line">
															<dd>
																<select id="propertyGallery_list" class="file-list" size="10" onchange="editor.listChanged('propertyJukebox_list')" onclick="editor.listChanged('propertyJukebox_list')"></select>
															</dd>
															<dd class="button-box">
																<a href="#void" class="up-button button" onclick="editor.moveUpFileList('propertyJukebox_list')" title="선택한 항목을 위로 이동합니다."><span><?php echo _t('위로')?></span></a>
																<a href="#void" class="dn-button button" onclick="editor.moveDownFileList('propertyJukebox_list')" title="선택한 항목을 아래로 이동합니다."><span><?php echo _t('아래로')?></span></a>
																<div class="clear"></div>
															</dd>
															<dd class="clear"></dd>
														</dl>
...
?>
												...
												<div id="colorPalette" style="display: none;">
													<table cellspacing="3" cellpadding="0" border="0">
														<tr>
															<td bgcolor="#008000" onclick="insertColorTag('#008000')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#009966" onclick="insertColorTag('#009966')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#99CC66" onclick="insertColorTag('#99CC66')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#999966" onclick="insertColorTag('#999966')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#CC9900" onclick="insertColorTag('#CC9900')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#D41A01" onclick="insertColorTag('#D41A01')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#FF0000" onclick="insertColorTag('#FF0000')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#FF7635" onclick="insertColorTag('#FF7635')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#FF9900" onclick="insertColorTag('#FF9900')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#FF3399" onclick="insertColorTag('#FF3399')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#9B18C1" onclick="insertColorTag('#9B18C1')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#993366" onclick="insertColorTag('#993366')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#666699" onclick="insertColorTag('#666699')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#0000FF" onclick="insertColorTag('#0000FF')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#177FCD" onclick="insertColorTag('#177FCD')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#006699" onclick="insertColorTag('#006699')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#003366" onclick="insertColorTag('#003366')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#333333" onclick="insertColorTag('#333333')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#000000" onclick="insertColorTag('#000000')" width="16" height="16">&nbsp;</td>			
															<td bgcolor="#8E8E8E" onclick="insertColorTag('#8E8E8E')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#C1C1C1" onclick="insertColorTag('#C1C1C1')" width="16" height="16">&nbsp;</td>
														</tr>
													</table>
												</div>
												<div id="markPalette" style="display: none;">
													<table cellspacing="3" cellpadding="0" border="0">
														<tr>
															<td bgcolor="#FFDAED" onclick="insertMarkTag('#202020', '#FFDAED')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#C9EDFF" onclick="insertMarkTag('#202020', '#C9EDFF')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#D0FF9D" onclick="insertMarkTag('#202020', '#D0FF9D')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#FAFFA9" onclick="insertMarkTag('#202020', '#FAFFA9')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#E4E4E4" onclick="insertMarkTag('#202020', '#E4E4E4')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#FF0000" onclick="insertMarkTag('#FFFFFF', '#FF0000')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#0000FF" onclick="insertMarkTag('#FFFFFF', '#0000FF')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#009966" onclick="insertMarkTag('#FFFFFF', '#009966')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#670787" onclick="insertMarkTag('#FFFFFF', '#670787')" width="16" height="16">&nbsp;</td>
															<td bgcolor="#333333" onclick="insertMarkTag('#FFFFFF', '#333333')" width="16" height="16">&nbsp;</td>
														</tr>
													</table>
												</div>
												<div id="textBox" style="display: none;">
													<table cellspacing="3" cellpadding="0" border="0">
														<tr>
															<td bgcolor="#FFDAED" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#FFDAED');" width="16" height="16">&nbsp;</td>
															<td bgcolor="#C9EDFF" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#C9EDFF');" width="16" height="16">&nbsp;</td>
															<td bgcolor="#D0FF9D" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#D0FF9D');" width="16" height="16">&nbsp;</td>
															<td bgcolor="#FAFFA9" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#FAFFA9');" width="16" height="16">&nbsp;</td>
															<td bgcolor="#E4E4E4" onclick="hideLayer('textBox'); TTCommand('Box', 'padding:10px; background-color:#E4E4E4');" width="16" height="16">&nbsp;</td>
														</tr>
													</table>
												</div>
<?php
