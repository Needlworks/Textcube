...
define('TATTERTOOLS_VERSION', '1.1.3 : Transition');
define('TATTERTOOLS_COPYRIGHT', 'Copyright &copy; 2004-2007. Needlworks / Tatter Network Foundation. All rights reserved. Licensed under the GPL.');
