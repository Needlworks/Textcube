...
<head>
	...
	<!--[if lte IE 6]>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/editor.ie.css" />
	<![endif]-->
	<!--[if IE 7]>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/editor.ie7.css" />
	<![endif]-->
...
?>
				...
				<div id="main-menu-box">
					<ul id="main-menu">
						...
						<li id="menu-post" class="selected"><a href="<?php echo $blogURL;?>/owner/entry"><span class="text"><?php echo _t('글');?></span></a></li>
