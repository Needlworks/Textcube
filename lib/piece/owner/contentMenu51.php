			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						...
						<li id="sub-menu-account" class="selected"><a href="<?php echo $blogURL?>/owner/setting/account"><span class="text"><?php echo _t('계정정보를 관리합니다')?></span></a></li>
						...
						<li id="sub-menu-helper"><a href="<?php echo _t(TATTERTOOLS_HOMEPAGE.'/doc/20')?>" onclick="window.open(this.href); return false;"><span class="text"><?php echo _t('도우미')?></span></a></li>
					</ul>
				</div>
