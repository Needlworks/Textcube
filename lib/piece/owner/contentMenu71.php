			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						<li class="list"><a href="<?php echo $blogURL?>/owner/notice"><span class="text"><?php echo _t('공지를 봅니다')?></span></a></li>
						<li class="add selected"><a href="<?php echo $blogURL?>/owner/notice/post"><span class="text"><?php echo _t('공지를 추가합니다')?></span></a></li>
