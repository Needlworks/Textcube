			<div id="layout-body">
				<h2><span>공지관리 &gt; 서브메뉴</span></h2>
				
				<div id="sub-menu-outbox">
					<ul id="sub-menu">
						<li class="list"><a href="<?php echo $blogURL?>/owner/notice"><span><?php echo _t('공지를 봅니다')?></span></a></li>
						<li class="add selected"><a href="<?php echo $blogURL?>/owner/notice/post"><span><?php echo _t('공지를 추가합니다')?></span></a></li>
