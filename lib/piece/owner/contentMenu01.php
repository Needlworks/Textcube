			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						...
						<li class="thread selected"><a href="<?=$blogURL?>/owner/entry/comment"><span class="text"><?php echo _t('댓글을 봅니다')?></span></a></li>
						...
						<li class="helper"><a href="http://www.tattertools.com/doc/5" onclick="window.open(this.href); return false;"><span class="text"><?php echo _t('도우미')?></span></a></li>
					</ul>
				</div>
