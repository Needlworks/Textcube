          ...
          <td valign="bottom" style="padding-left:10px">
            <table cellspacing="0">
              <tr>
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/entry/comment'" nowrap="nowrap" style="font-size:13px; color:#00A7DE; padding:3px 4px 0px 4px; font-weight:bold; background-color:#FFFFFF" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('댓글을 봅니다')?></td>
...
?>">
      ...
      <table cellspacing="0" style="width:100%; background-color:#FFFFFF">
        <tr>
		  ...
		  <form method="post" action="<?=$blogURL?>/owner/entry/comment">
