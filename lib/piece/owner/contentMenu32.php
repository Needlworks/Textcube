...
?>				
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/skin/setting'" nowrap="nowrap" style="font-size:13px; color:#00A7DE; padding:3px 4px 0px 4px; font-weight:bold; background-color:#FFFFFF" onmouseover="this.style.textDecoration='underline'"  onmouseout="this.style.textDecoration='none'"><?=_t('스킨에 맞춘 출력을 설정합니다')?></td>
