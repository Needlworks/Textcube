          ...
          <td valign="bottom" style="padding-left:10px">
            <table cellspacing="0">
              <tr>
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?php echo $blogURL?>/owner/skin'" nowrap="nowrap" style="font-size:13px; color:#FFFFFF; padding:3px 4px 0px 4px; font-weight:bold; background-color:#EAEBEC; background-image:url('<?php echo $service['path']?>/image/owner/subTabCenter.gif')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?php echo _t('스킨을 선택합니다')?></td>
                <td><img src="<?php echo $service['path']?>/image/owner/subTabRightSide.gif" alt="" /></td>
<?php 
?>								
				<td style="padding:0px 0px 0px 3px"><img src="<?php echo $service['path']?>/image/owner/subTabLeftSide.gif" width="4" height="26" alt="" /></td>
                <td class="pointerCursor" onclick="window.location.href = '<?php echo $blogURL?>/owner/skin/edit'" nowrap="nowrap" style="font-size:13px; color:#FFFFFF; padding:3px 4px 0px 4px; font-weight:bold; background-color:#EAEBEC; background-image:url('<?php echo $service['path']?>/image/owner/subTabCenter.gif')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?php echo _t('선택한 스킨을 편집합니다')?></td>
                <td><img src="<?php echo $service['path']?>/image/owner/subTabRightSide.gif" alt="" /></td>
<?php 
?>				
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?php echo $blogURL?>/owner/skin/setting'" nowrap="nowrap" style="font-size:13px; color:#00A7DE; padding:3px 4px 0px 4px; font-weight:bold; background-color:#FFFFFF" onmouseover="this.style.textDecoration='underline'"  onmouseout="this.style.textDecoration='none'"><?php echo _t('스킨에 맞춘 출력을 설정합니다')?></td>
...
echo "window.open('", _t('http://www.tattertools.com/doc/15'), "')";
?>">
              <tr>
