...
<title><?=htmlspecialchars($blog['title'])?> &gt; <?=_t('리더')?></title>
...
<link rel="stylesheet" type="text/css" href="<?=$service['path']?>/style/reader.css" />
</head>
<body id="Reader">
        ...
        <tr>
          <td style="background-image:url('<?=$service['path']?>/image/owner/menuP2.gif')">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td style="width:7px; padding-right:10px"><img src="<?=$service['path']?>/image/owner/menuP1.gif" /></td>
...
-->
                ...
                <td><img src="<?=$service['path']?>/image/owner/menuLine1.gif" alt="" /></td>
                <td class="menuItem3" nowrap="nowrap" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'" onclick="window.location.href = '<?=$blogURL?>/owner/statistics/visitor'"><?=_t('통계보기')?></td>
                <td><img src="<?=$service['path']?>/image/owner/menuLine1.gif" alt="" /></td>
                ...
                <td><img src="<?=$service['path']?>/image/owner/menuLine1.gif" alt="" /></td>
                <td>
                  <table cellspacing="0" class="menuItem1" onclick="window.location.href = '<?=$blogURL?>/owner/reader'">
                    <tr>
                      <td><img src="<?=$service['path']?>/image/owner/menuP3.gif" alt="" /></td>
                      <td class="menuItem2" nowrap="nowrap" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('리더')?></td>
          ...
          <td align="right" style="background-image:url('<?=$service['path']?>/image/owner/menuP2.gif')">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="150" align="center" style="background-image:url('<?=$service['path']?>/image/owner/menuBg.gif'); padding-top:8px"><img class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/'" src="<?=$service['path']?>/image/owner/blog.gif" alt="" /><img src="<?=$service['path']?>/image/owner/menuLine2.gif" /><img class="pointerCursor" src="<?=$service['path']?>/image/owner/logout.gif" onclick="window.location.href = '<?=$blogURL?>/logout'" alt="" /> </td>
                <td width="10"></td>
