          ...
          <td valign="bottom" style="padding-left:10px">
            <table cellspacing="0">
              <tr>
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/statistics/visitor'" nowrap="nowrap" style="font-size:13px; color:#00A7DE; padding:3px 4px 0px 4px; font-weight:bold; background-color:#FFFFFF" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('방문자의 통계를 봅니다')?></td>
