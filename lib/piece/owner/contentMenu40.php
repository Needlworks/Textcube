			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						...
						<li id="sub-menu-helper"><a href="<?php echo _t(TATTERTOOLS_HOMEPAGE.'/doc/16')?>" onclick="window.open(this.href); return false;"><span class="text"><?php echo _t('도우미')?></span></a></li>
					</ul>
				</div>
