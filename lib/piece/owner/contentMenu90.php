			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						<li class="trackback selected"><a href="<?=$blogURL?>/owner/trash/trackback"><span class="text"><?php echo _t('삭제된 트랙백')?></span></a></li>
						<li class="comment"><a href="<?=$blogURL?>/owner/trash/comment"><span class="text"><?php echo _t('삭제된 댓글')?></span></a></li>
						<li class="filter"><a href="<?=$blogURL?>/owner/trash/filter"><span class="text"><?php echo _t('필터')?></span></a></li>
