			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						...
						<li id="sub-menu-trash" class="selected"><a href="<?php echo $blogURL;?>/owner/entry/trash"><span class="text"><?php echo _t('휴지통');?></span></a></li>
						<li id="sub-menu-helper"><a href="<?php echo getHelpURL('entry/trash');?>" onclick="window.open(this.href); return false;"><span class="text"><?php echo _t('도우미');?></span></a></li>
					</ul>
				</div>
