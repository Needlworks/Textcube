...
?>				
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/entry/category'" nowrap="nowrap"  style="font-size:13px; color:#00A7DE; padding:3px 4px 0px 4px; font-weight:bold; background-color:#FFFFFF" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('분류를 관리합니다')?></td>
