			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						...
						<li class="category selected"><a href="<?=$blogURL?>/owner/entry/category"><span class="text"><?php echo _t('분류를 관리합니다')?></span></a></li>
						<li class="helper"><a href="http://www.tattertools.com/doc/8" onclick="window.open(this.href); return false;"><span class="text"><?php echo _t('도우미')?></span></a></li>
					</ul>
				</div>
