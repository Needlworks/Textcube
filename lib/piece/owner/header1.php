...
<title><?=htmlspecialchars($blog['title'])?> &gt; <?=_t('키워드관리')?></title>
          ...
          <td style="background-image:url('<?=$service['path']?>/image/owner/menuP2.gif')">
            <table cellspacing="0">
              <tr>
                ...
                <td>
                  <table cellspacing="0" class="menuItem1" onclick="window.location.href = '<?=$blogURL?>/owner/keyword'">
                    <tr>
                      <td><img src="<?=$service['path']?>/image/owner/menuP3.gif" alt="" /></td>
                      <td class="menuItem2" nowrap="nowrap" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('키워드관리')?></td>
