...
<title><?php echo htmlspecialchars($blog['title'])?> &gt; <?php echo _t('키워드관리')?></title>
<script type="text/javascript">
var servicePath = "<?php echo $blogURL?>"; var blogURL = "<?php echo $blogURL?>";
</script>
  ...
  <tr>
    ...
    <td valign="bottom">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td style="background-image:url('<?php echo $blogURL?>/image/owner/menuP2.gif')">
            <table cellspacing="0">
              <tr>
                <td style="width:7px; padding-right:10px"><img src="<?php echo $blogURL?>/image/owner/menuP1.gif" alt="" /></td>
                ...
                <td><img src="<?php echo $blogURL?>/image/owner/menuLine1.gif" alt="" /></td>
                <td>
                  <table cellspacing="0" class="menuItem1" onclick="window.location.href = '<?php echo $blogURL?>/owner/keyword'">
                    <tr>
                      <td><img src="<?php echo $blogURL?>/image/owner/menuP3.gif" alt="" /></td>
                      <td class="menuItem2" nowrap="nowrap" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?php echo _t('키워드관리')?></td>
                      <td><img src="<?php echo $blogURL?>/image/owner/menuP5.gif" alt="" /></td>
                    </tr>
                  </table>
                </td>
                <td><img src="<?php echo $blogURL?>/image/owner/menuLine1.gif" alt="" /></td>
          ...
          <td align="right" style="background-image:url('<?php echo $blogURL?>/image/owner/menuP2.gif')">
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td width="150" align="center" style="background-image:url('<?php echo $blogURL?>/image/owner/menuBg.gif'); padding-top:8px"><img class="pointerCursor" onclick="window.location.href = '<?php echo $blogURL?>/'" src="<?php echo $blogURL?>/image/owner/blog.gif" alt="" /><img src="<?php echo $blogURL?>/image/owner/menuLine2.gif" alt="" /><img class="pointerCursor" src="<?php echo $blogURL?>/image/owner/logout.gif" onclick="window.location.href = '<?php echo $blogURL?>/logout'" alt="" /> </td>
                <td width="10"></td>
                <td width="6"><img src="<?php echo $blogURL?>/image/owner/menuBg2.gif" alt="" /></td>
              </tr>
            </table>
          </td>
          <td width="10"></td>
...
<table cellspacing="0" width="100%" style="height:450px;background-image:url('<?php echo $blogURL?>/image/owner/bg.gif'); background-repeat:repeat-x">
  <tr>
