          ...
          <td valign="bottom" style="padding-left:10px">
            <table cellspacing="0">
              <tr>
                ...
                <td style="padding:0px 0px 0px 3px"><img src="<?=$service['path']?>/image/owner/subTabLeftSide.gif" width="4" height="26" alt="" /></td>
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/entry/comment'" nowrap="nowrap" style="font-size:13px; color:#FFFFFF; padding:3px 4px 0px 4px; font-weight:bold; background-color:#EAEBEC; background-image:url('<?=$service['path']?>/image/owner/subTabCenter.gif')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('댓글을 봅니다')?></td>
                <td><img src="<?=$service['path']?>/image/owner/subTabRightSide.gif" alt="" /></td>
<?
?>				
				<td style="padding:0px 0px 0px 3px"><img src="<?=$service['path']?>/image/owner/subTabLeftSide.gif" width="4" height="26" alt="" /></td>
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/entry/notify'" nowrap="nowrap" style="font-size:13px; color:#FFFFFF; padding:3px 4px 0px 4px; font-weight:bold; background-color:#EAEBEC; background-image:url('<?=$service['path']?>/image/owner/subTabCenter.gif')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('댓글 알리미')?></td>
                <td><img src="<?=$service['path']?>/image/owner/subTabRightSide.gif" alt="" /></td>
<?
?>	
                <td style="padding:0px 0px 0px 3px"><img src="<?=$service['path']?>/image/owner/subTabActiveLeftSide.gif" alt="" /></td>
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/entry/trackback'" nowrap="nowrap" style="font-size:13px; color:#00A7DE; padding:3px 4px 0px 4px; font-weight:bold; background-color:#FFFFFF" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('트랙백을 봅니다')?></td>
...
?>">
      ...
      <table cellspacing="0" style="width:100%; background-color:#FFFFFF">
        <tr>
		  ...
		  <form method="post" action="<?=$blogURL?>/owner/entry/trackback">
