			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						<li class="add"><a href="#void" onclick="window.location.href = '<?=$blogURL?>/owner/entry/post'<?=(getDraftEntryId() ? "+(confirm('" . _t('임시 저장본을 보시겠습니까?\t') . "') ? '?draft' : '')" : '')?>"><span class="text"><?php echo _t('새 글을 씁니다')?></span></a></li>
						...
						<li class="trackback selected"><a href="<?=$blogURL?>/owner/entry/trackback"><span class="text"><?php echo _t('트랙백을 봅니다')?></span></a></li>
						<li class="category"><a href="<?=$blogURL?>/owner/entry/category"><span class="text"><?php echo _t('분류를 관리합니다')?></span></a></li>
						<li class="helper"><a href="http://www.tattertools.com/doc/7" onclick="window.open(this.href); return false;"><span class="text"><?php echo _t('도우미')?></span></a></li>
					</ul>
				</div>
