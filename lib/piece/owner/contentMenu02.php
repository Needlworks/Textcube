			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						...
						<li id="sub-menu-list"><a href="<?php echo $blogURL;?>/owner/entry"><span class="text"><?php echo _t('글목록');?></span></a></li>
						...
						<li id="sub-menu-trackback" class="selected"><a href="<?php echo $blogURL;?>/owner/entry/trackback"><span class="text"><?php echo _t('트랙백');?></span></a></li>
