			<div id="layout-body">
				...
				<div id="sub-menu-outbox">
					<ul id="sub-menu">
						...
						<li class="list selected"><a href="<?=$blogURL?>/owner/entry"><span><?php echo _t('글을 봅니다')?></span></a></li>
						...
						<li class="helper"><a href="#void" onclick="<?php echo 'window.open(\'', _t('http://www.tattertools.com/doc/4'), '\')'; ?>"><span><?php echo _t('도우미')?></span></a></li>
					</ul>
				</div>
