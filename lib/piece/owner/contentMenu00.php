			<div id="layout-body">
				...
				<div id="sub-menu-box">
					<ul id="sub-menu">
						...
						<li class="list selected"><a href="<?=$blogURL?>/owner/entry"><span class="text"><?php echo _t('글을 봅니다')?></span></a></li>
						...
						<li class="helper"><a href="http://www.tattertools.com/doc/4" onclick="window.open(this.href); return false;"><span class="text"><?php echo _t('도우미')?></span></a></li>
					</ul>
				</div>
