...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $service['path']?>/style/default/default-skin.css" />
	<!--[if lte IE 6]><link rel="stylesheet" type="text/css" href="<?php echo $service['path']?>/style/default/default-ie.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo $service['path']?>/style/default/default-skin-ie.css" /><![endif]-->
</head>
<body id="body-skin">
	<div id="temp-wrap">
		<div id="all-wrap">
