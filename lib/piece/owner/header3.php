...
-->
                ...
                <td><img src="<?php echo $service['path']?>/image/owner/menuLine1.gif" alt="" /></td>
                <td>
                  <table cellspacing="0" class="menuItem1" onclick="window.location.href = '<?php echo $blogURL?>/owner/skin'">
                    <tr>
                      <td><img src="<?php echo $service['path']?>/image/owner/menuP3.gif" alt="" /></td>
                      <td class="menuItem2" nowrap="nowrap" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?php echo _t('스킨관리')?></td>
