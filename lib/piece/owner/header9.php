...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/trash.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/basic.opera.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/trash.opera.css" />
	<!--[if lte IE 6]><link rel="stylesheet" type="text/css" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/basic.ie.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/trash.ie.css" /><![endif]-->
...
?>
				...
				<div id="main-menu-box">
					<ul id="main-menu">
						...
						<li id="menu-trash" class="selected"><a href="<?php echo $blogURL;?>/owner/trash/comment"><span class="text"><?php echo _t('휴지통');?></span></a></li>
