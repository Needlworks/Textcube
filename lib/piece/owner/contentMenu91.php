			<div id="layout-body">
				...
				<div id="sub-menu-outbox">
					<ul id="sub-menu">
						<li class="trackback"><a href="<?=$blogURL?>/owner/trash/trackback"><span><?php echo _t('트랙백을 관리합니다')?></span></a></li>
						<li class="comment selected"><a href="<?=$blogURL?>/owner/trash/comment"><span><?php echo _t('댓글을 관리합니다')?></span></a></li>
