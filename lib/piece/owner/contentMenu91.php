			<div id="layout-body">
				...
				<div id="sub-menu-outbox">
					<ul id="sub-menu">
						<li class="trackback"><a href="<?=$blogURL?>/owner/trash/trackback"><span><?php echo _t('삭제된 트랙백')?></span></a></li>
						<li class="comment selected"><a href="<?=$blogURL?>/owner/trash/comment"><span><?php echo _t('삭제된 댓글')?></span></a></li>
