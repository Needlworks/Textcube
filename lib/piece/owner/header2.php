...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/link.css" />
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/basic.opera.css" />
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/link.opera.css" />
	<!--[if lte IE 6]><link rel="stylesheet" type="text/css" media="screen" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/basic.ie.css" />
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $service['path'].$adminSkinSetting['skin'];?>/link.ie.css" /><![endif]-->
...
?>
				...
				<div id="main-menu-box">
					<ul id="main-menu">
						...
						<li id="menu-link" class="selected"><a href="<?php echo $blogURL;?>/owner/link"><span class="text"><?php echo _t('링크');?></span></a></li>
