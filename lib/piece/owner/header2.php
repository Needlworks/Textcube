...
<title><?=htmlspecialchars($blog['title'])?> &gt; <?=_t('링크관리')?></title>
...
-->
                ...
                <td><img src="<?=$service['path']?>/image/owner/menuLine1.gif" alt="" /></td>
                <td>
                  <table cellspacing="0" class="menuItem1" onclick="window.location.href = '<?=$blogURL?>/owner/link'">
                    <tr>
                      <td><img src="<?=$service['path']?>/image/owner/menuP3.gif" alt="" /></td>
                      <td class="menuItem2" nowrap="nowrap" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('링크관리')?></td>
