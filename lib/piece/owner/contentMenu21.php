          ...
          <td valign="bottom" style="padding-left:10px">
            <table cellspacing="0">
              <tr>
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/link'" nowrap="nowrap" style="font-size:13px; color:#FFFFFF; padding:3px 4px 0px 4px; font-weight:bold; background-color:#EAEBEC; background-image:url('<?=$service['path']?>/image/owner/subTabCenter.gif')" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('목록을 봅니다')?></td>
                ...
                <td class="pointerCursor" onclick="window.location.href = '<?=$blogURL?>/owner/link/add'" nowrap="nowrap" style="font-size:13px; color:#00A7DE; padding:3px 4px 0px 4px; font-weight:bold; background-color:#FFFFFF" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><?=_t('새로운 링크를 추가합니다')?></td>
...
?>">
      ...
      <table cellspacing="0" style="width:100%; background-color:#FFFFFF">
        <tr>
		  ...
		  <form method="post" action="<?=$blogURL?>/owner/link">
