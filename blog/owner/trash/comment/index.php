...
?>
										<tr class="<?php echo $className?> inactive-class" onmouseover="rolloverClass(this, 'over')" onmouseout="rolloverClass(this, 'out')">
											<td class="selection"><input type="checkbox" name="entry" value="<?=$comment['id']?>" onclick="document.getElementById('allChecked').checked=false; toggleThisTr(this);" disabled="disabled" /></td>
...
?>
											...
											<td class="delete">
												<a class="delete-button button" href="#void" onclick="<?=$blogURL?>/owner/trash/comment/delete/<?=$comment['id']?>?javascript=disabled" title="<?=_t('이 댓글을 삭제합니다.')?>"><span class="text"><?=_t('삭제')?></span></a>
											</td>
						  				</tr>
<?
}
