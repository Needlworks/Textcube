...
?>
							...
							<form id="categoryForm" class="data-inbox" method="post" action="<?=$blogURL?>/owner/trash/comment">
								<div class="grouping">
...
?>
							...
							<form id="listForm" method="post" action="<?=$blogURL?>/owner/trash/comment">
								<div class="grouping">
									<input type="hidden" name="page" value="<?=$suri['page']?>" />
...
?>
							...
							<form id="searchForm" class="data-inbox" method="post" action="<?=$blogURL?>/owner/trash/comment">
