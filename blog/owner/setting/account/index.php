										...
										<dd id="letter">
											<div id="letter-head">
												<div id="receiver-line" class="line">
													<label for="invitation_receiver"><?=_t('받는 사람')?></label>
													<input type="text" id="invitation_receiver" class="text-input" name="text" value="<?=_t('이름&lt;이메일&gt; 혹은 이메일')?>" onclick="if(!this.selected) this.select();this.selected=true;" onblur="this.selected=false;" onkeydown="refreshReceiver(event)" />
												</div>
											...
											<div id="letter-foot">												<div id="sender-line" class="line">
													<label for="invitation_sender"><?=_t('보내는 사람')?></label>
													<input type="text" id="invitation_sender" class="text-input" name="text2" value="<?=htmlspecialchars($user['name'] . '<' . $user['loginid'] . '>')?>" />
												</div>
											</div>
										</dd>
									</dl>
