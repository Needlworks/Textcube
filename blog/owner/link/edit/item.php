          ...
          <td valign="top" style="height:50px; padding:5px 15px 15px 15px">
                ...
                <td style="background-color:#EBF2F8; padding:10px 5px 10px 5px">
                  <table cellspacing="0">
                    <tr>
                      ...
                      <td>
                        <input type="text" class="text1" name="rss" style="width:300px" value="<?=$link['rss']?>"/>
                      </td>
                      <td>
                  ...
                  <table cellspacing="0">
                    <tr>
                      ...
                      <td>
                        <input name="name" type="text" class="text1" id="name" style="width:300px" value="<?=htmlspecialchars($link['name'])?>" />
                      </td>
                    </tr>
                  </table>
                  <table cellspacing="0">
                    <tr>
                      ...
                      <td>
                        <input name="url" type="text" class="text1" id="url" style="width:300px" value="<?=htmlspecialchars($link['url'])?>" />
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <div align="center">
              <table style="margin-top:10px">
                <tr>
                  <td>
                    <table class="buttonTop" cellspacing="0" onclick="updateLink()">
                      <tr>
                        <td><img width="4" height="24" src="<?=$service['path']?>/image/owner/buttonLeft.gif" alt="" /></td>
                        <td class="buttonTop" style="work-break:keep-all;background-image:url('<?=$service['path']?>/image/owner/buttonCenter.gif')"><?=_t('편집하기')?></td>
                        <td><img width="5" height="24" src="<?=$service['path']?>/image/owner/buttonRight.gif" alt="" /></td>
                      </tr>
                    </table>
                  </td>
