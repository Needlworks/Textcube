...
?>
									<tr id="link_<?php echo $link['id'];?>" class="<?php echo $className;?> inactive-class" onmouseover="rolloverClass(this, 'over')" onmouseout="rolloverClass(this, 'out')">
										...
										<td class="edit"><a id="link-visible-<?php echo $link['id']?>" class="<?php echo $visible_class ?>" href="<?php echo $blogURL;?>/owner/link/visible/<?php echo $link['id'];?>" onclick="toggleVisibility(<?php echo $link['id'];?>); return false;" title="<?php echo _t('방문자에게 보일지 여부를 선택합니다.');?>"><span><?php echo _t('보기');?></span></a></td>
