...
?>
							...
							<form id="categoryForm" class="data-inbox" method="post" action="<?=$blogURL?>/owner/entry/trackback">
								<div class="grouping">
...
?>
							...
							<form id="listForm" method="post" action="<?=$blogURL?>/owner/entry/trackback">
								<div class="grouping">
									<input type="hidden" name="page" value="<?=$suri['page']?>" />
