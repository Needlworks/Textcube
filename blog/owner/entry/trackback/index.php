...
?>
							...
							<form id="category-form" class="category-box" method="post" action="<?=$blogURL?>/owner/entry/trackback">
								<div class="section">
...
?>
							...
							<form id="search-form" class="data-subbox" method="post" action="<?=$blogURL?>/owner/entry/trackback">
