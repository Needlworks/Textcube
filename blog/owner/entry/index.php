...
?>
											...
											<td class="delete">
												<a class="delete-button button" href="<?php echo $blogURL?>/owner/entry/delete/<?=$entry['id']?>?javascript=disabled" onclick="deleteEntry(<?=$entry['id']?>)" title="<?=_t('이 포스트를 삭제합니다.')?>"><span class="text"><?=_t('삭제')?></span></a>
											</td>
										</tr>
<?
								}
