...
?>
							...
							<form id="category-form" class="data-inbox" method="post" action="<?=$blogURL?>/owner/entry/comment">
								<div class="grouping">
...
?>
							...
							<form id="search-form" class="data-inbox" method="post" action="<?=$blogURL?>/owner/entry/comment">
