...
?>
							...
							<form id="category-form" class="category-box" method="post" action="<?=$blogURL?>/owner/entry/comment">
								<div class="section">
...
?>
							...
							<form id="list-form" method="post" action="<?=$blogURL?>/owner/entry/comment">
...
?>
							...
							<form id="search-form" class="data-subbox" method="post" action="<?=$blogURL?>/owner/entry/comment">
