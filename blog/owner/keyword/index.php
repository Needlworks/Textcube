...
//]]>
            ...
            <table cellspacing="0" style="width:100%; margin-bottom:1px">
              <tr style="background-color:#00A6ED; height:24px; background-image: url('<?=$blogURL?>/image/owner/subTabCenter.gif')">
                ...
                <td width="320" style="color:#FFFFFF; padding:2px 7px 0px 7px; font-size:13px;	font-weight:bold"><?=_t('키워드')?></td>
                <td></td>
              </tr>
<?
$more = false;
            ...
            <table cellspacing="0" style="width:100%; border-style:solid; border-width:2px 0px 2px 0px; border-color:#00A6ED">
              <tr>
                <td style="background-color:#EBF2F8; padding:10px 5px 10px 5px">
                  ...
                  <table cellspacing="0" width="100%">
                    <tr style="height:22px">
                      <td style="padding:0px 7px 0px 7px; font-size:12px" width="55"><?=_f('총 %1건', empty($paging['total']) ? "0" : $paging['total'])?></td>
...
?>
                      ...
                      <td align="right">
                        <table cellspacing="0" style="margin-right:5px">
                          <tr>
                            <td style="padding:0px 7px 0px 10px; font-size:12px" ><?=_t('키워드')?> | <?=_t('설명')?></td>
