						...
						<div id="part-data-optimize" class="part">
							...
							<div class="data-inbox main-explain-box">
								<div class="image" onclick="optimizeData()">
									<img src="<?php echo $service['path'].$adminSkinSetting['skin'];?>/image/dbOptimize.gif" alt="<?php echo _t('데이터베이스 최적화 이미지');?>" />
						...
						<div id="part-data-backup" class="part">
							...
							<div class="data-inbox main-explain-box">
								<div class="image" onclick="showDialog('DBExport')">
									<img src="<?php echo $service['path'].$adminSkinSetting['skin'];?>/image/dbExport.gif" alt="<?php echo _t('데이터 백업 이미지');?>" />
...
?>
											...
											<div id="select-web" title="<?php echo _t('백업파일의 크기가 업로드 허용 용량을 초과하는 경우, FTP 등을 이용하여 계정의 홈페이지에 직업 업로드한 후 이 파일의 위치를 지정하여 데이터베이스를 복원할 수 있습니다.');?>"><input type="radio" id="importFromWeb" class="radio" name="importFrom" value="web" onclick="if (this.checked) {hideLayer('uploadBackup'); showLayer('remoteBackup'); document.getElementById('backupPath').disabled = true; document.getElementById('backupURL').disabled = false;}" /> <label for="importFromWeb"><?php echo _t('웹에서 백업파일 가져오기.');?></label></div>
						...
						<div id="part-data-remove" class="part">
							...
							<div class="data-inbox main-explain-box">
								<div class="image" onclick="showDialog('DBRemove')">
									<img src="<?php echo $service['path'].$adminSkinSetting['skin'];?>/image/dbClear.gif" alt="<?php echo _t('데이터 삭제 이미지');?>" />
