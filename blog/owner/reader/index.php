...
?>
			<script type="text/javascript">
				//<![CDATA[
					...
					var s_groupAdded = "<?php echo _t('그룹이 추가됐습니다.');?>";
					...
					var s_groupModified = "<?php echo _t('그룹이 수정됐습니다.');?>";
					...
					var s_feedModified = "<?php echo _t('피드가 수정됐습니다.');?>";
					var s_editingFeed = "<?php echo _t('피드를 수정하고 있습니다.');?>";
					var s_feedRemoved = "<?php echo _t('피드가 삭제됐습니다.');?>";
