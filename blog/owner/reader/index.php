        ...
        <tr>
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="100" align="right" valign="bottom"><a class="pointerCursor" width="36" height="15" onclick="Reader.prevEntry()"><?=_t('이전')?></a><img src="<?=$service['path']?>/image/owner/reader/pageSp.gif" width="5" height="15" hspace="2" /><a class="pointerCursor" width="36" height="15" onclick="Reader.nextEntry()"/><?=_t('다음')?></a></td>
