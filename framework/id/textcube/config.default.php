...
define('TEXTCUBE_VERSION_ID', '1.10.6');
define('TEXTCUBE_REVISION', 'root-main-branch1.10-r39');
define('TEXTCUBE_CODENAME', 'Release Candidate 2');
...
define('TEXTCUBE_RESOURCE_URL', 'http://resources.textcube.org/1.10.6');
