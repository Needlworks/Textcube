...
TFOOT;
    ...
    if (isset($service['pagecache']) && $service['pagecache'] == true) {
        print '<li>Page cache Enabled</li>' . CRLF;
    } else {
        print '<li>Page cache Disabled</li>' . CRLF;
    }
    if (isset($service['skincache']) && $service['skincache'] == true) {
        print '<li>Skin cache Enabled</li>' . CRLF;
    } else {
        print '<li>Skin cache Disabled</li>' . CRLF;
    }
    if (isset($service['memcached']) && $service['memcached'] == true) {
        print '<li>Memcached module Enabled</li>' . CRLF;
    } else {
        print '<li>Memcached module Disabled</li>' . CRLF;
    }
    print '</ul>' . CRLF;
