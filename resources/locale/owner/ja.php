...
$__text['&copy; 2004 - 2009. 모든 저작권은 개발자 및 공헌자에게 있습니다.<br />텍스트큐브는 니들웍스/TNF에서 개발합니다.<br />텍스트큐브와 텍스트큐브 로고는 니들웍스의 상표입니다.'] = '&copy; 2004－2009. <br />全ての著作権は開発者とその貢献者がお持ちしております。<br />TextcubeはNeedlworks/TNFから開発しております。<br />TextcubeとそのロゴはNeedlworksのトレードマークであります。';	
...
$__text['Line 글쓰기를 검색 공급자에 추가하기'] = 'Line作成をブラウザーの検索プロバイダに追加';	
$__text['Line은 짧은 글로 생각이나 느낌을 정리하기 위한 기능입니다.'] = 'Lineは短い文長で細かな思いや考えを記録するための機能であります。';	
$__text['Maintainer'] = '開発管理';	
$__text['Memcached 모듈을 사용합니다.'] = 'Memcachedモジュールを利用します。';	
...
$__text['공개여부'] = '公開ルール';	
$__text['공공 장소의 컴퓨터에서는 추가하지 마시기 바랍니다. 만약 실수로 추가하신 경우, 옆의 새로 고침 버튼을 눌러 Line의 비밀 번호를 변경하면, 기존에 등록한 검색 표시줄에서 글을 쓸 수 없게 됩니다.'] = '公用パソコンではLine機能を利用しないでください。もしや公用パソコンでLineの検索プロバイダーを追加したら、「リフラッシュ」をクリックして既登録の検索プロバイダーを無効にしてください。';	
...
$__text['글의 걸린글 정보를 다시 계산해서 저장합니다.'] = '記事受信情報を再計算中…';	
$__text['글의 댓글 정보를 다시 계산해서 저장합니다.'] = '記事のコメント情報を再計算中…';	
...
$__text['댓글, 걸린글, 리퍼러가 입력될 때 아래의 단어가 포함되어 있으면 알림창을 띄우고 휴지통으로 보냅니다.'] = 'コメントや記事、リファラの受信時に、下のキーワードを含めているとエラーメッセージを表示しごみ箱へ転送します。';	
$__text['댓글'] = 'コメント';	
...
$__text['만약 이 페이지를 보고 계시다면 Apache mod_rewrite와 호환되지 않는 Rewrite 모듈을 사용 중이거나 아예 모듈이 없는 경우입니다.'] = 'あなたにこのページが表示されていると、Apache mod_rewriteとの交換性のないRewriteモジュールのご利用しているか、モジュールのインストールを必要としています。';	
$__text['매력적인'] = '魅力的';	
$__text['머리말'] = '端書き';	
...
$__text['모두 읽은 상태로 변경하였습니다.'] = '全記事の転換完了';	
...
$__text['백업파일에 포함된 비정상적인 글자를 교정합니다.'] = 'バックアップデータが含む例外文字の校正中…';	
$__text['백업파일을 가져오고 있습니다.'] = 'バックアップデータを読み込み中…';	
...
$__text['보호설정'] = '保護設定';	
$__text['복구'] = '復元';	
$__text['복원 위치를 준비하고 있습니다.'] = '復元位置を準備中…';	
$__text['복원'] = '復元';	
...
$__text['분류의 글 정보를 다시 계산해서 저장합니다.'] = '分類の記事の情報を再計算中…';	
$__text['분야'] = '分野';	
$__text['분야가 같은'] = '同分野';	
$__text['불러오고 있습니다'] = '取り込み中…';	
$__text['불러오는 중..'] = 'ロード中…';	
$__text['불러오지 못했습니다'] = '取り込み失敗';	
$__text['불러왔습니다.'] = '取り込み完了';	
...
$__text['블로그 표지 위젯 플러그인은 블로그의 첫 화면이나 표지 화면에 출력되는 위젯을 추가해 줍니다.'] = 'そして、メタページWidgetsはブログのメタページから表示するされるプラグインのことです。<br />';	
...
$__text['블로그의 속도 향상을 위하여 Memcached를 사용합니다. 이 기능을 사용하기 위해서는 서버에 Memcached가 설치되어 있고, PHP가 Memcached를 사용할 수 있도록 설정되어 있어야 합니다.'] = 'ブログの速度向上のためMemcachedを設定します。ただし、この機能の利用のためにはサーバーに既にインストールされたMemcachedモジュールとphpからの利用設定を必要とします。';	
...
$__text['서버의 트래픽을 줄이기 위하여 동작시 필요한 일부 리소스를 공개 텍스트큐브 리소스 저장소(%1)에서 읽어오거나 지정한 서버에서 읽어옵니다.'] = 'サーバーの転送量を減少させるため、一部の構成要素をTextcube構成要素サーバー(%1)、または設定位置から呼び込みます。';	
...
$__text['연결하기: 로그인하면 본 계정의 권한을 갖습니다.'] = '権限付与：サインインしたらすべての権限付与';	
$__text['연결하기'] = '権限付与';	
...
$__text['옆의 링크를 누르면 지금 사용하시는 브라우저의 검색 입력줄에 이 블로그의 Line이 추가됩니다.'] = 'この側のリンクをクリックするとブラウザーの検索プロバイダーにこのブログのLine作成が可能になります。';	
...
$__text['오픈아이디를 현재 아이디와 연결합니다.'] = '利用中の名前をOpenIDとリンク';	
$__text['올바르지 않은 블로그 주소입니다'] = '正しくない形式のブログアドレス';	
...
$__text['이올린'] = 'イオリン';	
$__text['이올린에 발행된 글만을 RSS 및 ATOM 피드로 내보냅니다.'] = 'RSSフィードから発行記事のみを公開';	
...
$__text['장면전환효과'] = '転換効果';	
$__text['잦은 입출력으로 비효율적이 된 데이터베이스를 최적화 합니다.'] = '非効率的なデータベースの最適化中…';	
...
$__text['추가'] = '作成';	
$__text['추가하기'] = '作成';	
$__text['추가한 후에는 브라우저의 검색 입력줄에서 추가된 Line을 선택하고 글을 입력하여 바로 Line을 쓸 수 있습니다.'] = '検索プロバイダーに追加した後では、検索プロバイダーからこのブログのLine機能をご利用できます。';	
$__text['출력 설정'] = '表示設定';	
...
$__text['코드'] = 'コード';	
$__text['크기'] = 'Size';	
$__text['크로스 브라우징을 지원하는 트랙백 복사를 위한 플래시를 사용합니다.'] = '送信先の自動コピー機能を設定';	
$__text['클릭 설정'] = 'クリック設定';	
$__text['키로그'] = 'キーログ';	
...
$__text['태그와 태그 관계 정보를 다시 계산해서 저장합니다.'] = 'タグやタグリレーション情報を再計算中…';	
...
$__text['텍스트큐브의 자바 스크립트 컴포넌트등을 외부에서 불러옵니다.'] = 'Textcubeの構成要素を外部位置に設定します。';	
...
$__text['플래시 트랙백 주소 복사 사용'] = '送信先コピー';	
...
$__text['플러그인 설정 데이터를 모두 초기화 합니다. 사용중인 모든 플러그인을 미사용으로 초기화 한다는 의미입니다.<br />플러그인 설정 데이터의 복원은 백업파일로만 가능하므로 먼저 백업을 하시기 바랍니다.'] = '全体設定データをリセットします。利用中のプラグインは全部解除に転換されます。<br />データの復元はバックアップだけでできますので必ずバックアップをしてください。';	
...
$__text['플러그인 설정 데이터를 초기화 합니다'] = '<span style="font-weight:bold; color:#c11;">プラグイン設定データリセット</span>';	
$__text['플러그인 설정'] = 'プラグイン設定';	
$__text['플러그인 설정'] = 'プラグイン設定';	
$__text['플러그인 설정데이터 복원을 시작합니다'] = 'プラグイン設定データ復元';	
$__text['플러그인 설정을 복원하고 있습니다.'] = 'プラグイン設定の復元中…';	
...
$__text['피드를 가져오고 있습니다.'] = 'フィードを取り込み中…';	
