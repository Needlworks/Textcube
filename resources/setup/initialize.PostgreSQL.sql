...
CREATE UNIQUE INDEX RemoteResponseLogs_blogid_id_idx ON [##_dbPrefix_##]RemoteResponseLogs (blogid, id);
...
CREATE INDEX RemoteResponses_isFiltered_idx ON [##_dbPrefix_##]RemoteResponses ("isFiltered");
CREATE INDEX RemoteResponses_blogid_isFiltered_written_idx ON [##_dbPrefix_##]RemoteResponses (blogid, "isFiltered", written);
