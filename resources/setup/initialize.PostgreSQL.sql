...
CREATE UNIQUE INDEX RemoteResponseLogs_blogid_id_idx ON [##_dbPrefix_##]TrackbackLogs (blogid, id);
...
CREATE INDEX RemoteResponses_isFiltered_idx ON [##_dbPrefix_##]Trackbacks (isFiltered);
CREATE INDEX RemoteResponses_blogid_isFiltered_written_idx ON [##_dbPrefix_##]Trackbacks (blogid, isFiltered, written);
