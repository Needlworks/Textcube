...
function openFullScreen(content,caption,root) {
	...
	<script type="text/javascript" src="'+root+'/resources/script/common3.min.js"></script>\
	<style>\
		body {\
			margin:0px;	\
			width: 100%; \
...
function writeCode(str, id) {
	str = str.replace('src="', 'src="//' + document.domain + ((document.location.port)? ':'+document.location.port : ''));
