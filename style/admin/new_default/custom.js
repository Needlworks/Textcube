...
function execLoadTransform() {
	...
	for (i=0; i<tempIds.length; i++) {
		if (document.getElementById(tempIds[i])) {
			...
			tempBox.className = "data-subbox";
			tempBox.appendChild(document.getElementById("sorting-line"));
			tempBox.appendChild(document.getElementById("activate-status-line"));
			//removeItselfById("sorting-line");
			//removeItselfById("activate-status-line");
			document.getElementById(tempIds[i]).appendChild(tempBox);
		}
	}
