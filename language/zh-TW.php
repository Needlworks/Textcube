...
$__text["%1 설정"] = '%1設定';
$__text["%1님께서 블로그의 팀원으로 초대합니다"] = '%1邀請您一同撰寫網誌';
...
$__text['(예: %1/entry/텍스트큐브로-오신-것을-환영합니다)'] = '(例: %1/entry/我的網誌)';
$__text['(이름 없음 %1)'] = '(無名 %1)';
...
$__text['1차 블로그 도메인을 변경하지 못했습니다'] = '未能修改網誌一級地址';
$__text['1차 블로그 주소'] = '一級網誌地址';
$__text['1차 블로그 주소가 올바르지 않습니다.'] = '一級網誌地址不正確';
$__text['2차 블로그 주소'] = '二級網誌地址';
$__text['2차 블로그 주소가 비어있어서 기본 블로그 주소로 설정할 수 없습니다'] = '沒有填寫二級網誌地址,不能設定為默認網誌地址';
$__text['2차 블로그 주소가 올바르지 않습니다.'] = '二級網誌地址不正確';
$__text['2차 블로그 주소를 변경하지 못했습니다'] = '為能修改二級網誌地址';
...
//$__text['HTML'] = '';
$__text['IP 필터링'] = 'IP過濾';
$__text['Icon design'] = '圖示設計';
//$__text['Internationalization'] = '';
$__text['Japanese'] = '日文';
$__text['Korean'] = '韓文';
$__text['Logo design'] = 'Logo設計';
...
$__text['RSS 글 개수를 변경하지 못했습니다.'] = '未能修改RSS文章數目';
...
$__text['관리자 화면 언어'] = '管理頁語言';
$__text['관리자 화면의 언어를 설정합니다.<br />한국어 블로그를 운영하고 계신다면 한국어를 선택해 주십시오.'] = '設定管理頁面語言.<br />若您要以中文管理,請選擇中文.';
...
$__text['그룹 수정하기'] = '編輯組';
$__text['그룹 없음'] = '無群組';
$__text['그룹 이름을 입력하세요.'] = '請輸入組名稱';
$__text['그룹을 삭제하고 있습니다.'] = '刪除組';
$__text['그룹을 삭제하였습니다.'] = '刪除了組';
$__text['그룹을 수정하고 있습니다.'] = '編輯組';
$__text['그룹을 수정하였습니다.'] = '編輯了組';
$__text['그룹을 추가하고 있습니다.'] = '新增組';
$__text['그룹을 추가하세요.'] = '請建立組';
$__text['그룹을 추가하였습니다.'] = '增加了組';
$__text['글 개수'] = 'RSS網誌數';
$__text['글 내용'] = '文章內容';
...
$__text['글의 걸린글 정보를 다시 계산해서 저장합니다.'] = '重新計算引用文章數,並保存.';
$__text['글의 댓글 정보를 다시 계산해서 저장합니다.'] = '重新計算回覆訊息,並保存.';
$__text['글이 전부 삭제되지는 않고 팀블로그의 로그인 데이터만 삭제됩니다'] = '不會刪除全部文章，只刪除團隊網誌的登入訊息。';
...
$__text['기능'] = '功能';
$__text['기본 도메인'] = '基本網域';
$__text['기본 블로그 도메인을 변경하지 못했습니다'] = '未能修改網誌基本網域';
$__text['기본 설정'] = '基本設定';
$__text['기본 스킨을 변경합니다.'] = '修改基本模板';
$__text['기본 편집기'] = '默認編輯器';
$__text['기본 포매터'] = '默認formatter';
$__text['기본값'] = '基本值';
$__text['기본모드'] = '基本模式';
$__text['기울임'] = '斜體';
$__text['기타 플러그인'] = '其他插件';
...
$__text['다른 사람의 블로그에 단 댓글에 대한 댓글이 등록되면 알려줍니다. 알리미가 동작하기 위해서는 댓글 작성시 홈페이지 기입란에 자신의 블로그 주소(<samp>%1</samp>)를 입력하셔야 합니다.'] = '在其他人網誌裡的留言有回覆時會在這裡通知您，要使用這個功能在留言時要填寫您的網誌地址:<samp>%1</samp><br />&nbsp;<br />';
...
$__text['데이터 백업 기능을 통해 서버에 저장해 두었던 기존 파일을 이용해 데이터베이스를 복원합니다. 데이터 파일에 대해서는 위의 정보를 참고하십시오.'] = '使用通過資料備份功能備份到主機上的備份文件還原資料，關於備份文件請參考以上訊息.';
...
$__text['도메인네임(DNS)으로 블로그 식별'] = '使用DNS識別網誌';
$__text['도우미'] = '幫助';
...
$__text['로그아웃'] = '登出';
$__text['로그아웃하고 블로그 메인으로 이동합니다.'] = '登出並轉到網誌首頁';
$__text['로그인 회수'] = '登入次數';
$__text['로그인'] = '登入';
$__text['로딩 중..'] = '載入中';
$__text['로딩되었습니다.'] = '已完成';
...
$__text['백업을 저장하고 있습니다.'] = '正在保存備份資料.';
$__text['백업을 저장하지 못했습니다.'] = '保存備份資料失敗.';
$__text['백업이 저장되었습니다.'] = '保存備份資料成功.';
...
$__text['백업파일 올리기.'] = '上傳備份文件';
$__text['백업파일에 복원할 데이터가 없습니다.'] = '備份文件中沒有要恢復的資料.';
$__text['백업파일에 비정상적인 글자가 포함된 경우 복원에 실패할 수 있습니다. 비정상적인 글자를 교정하여 복원이 가능하도록 합니다. 이를 사용할 경우 복원에 많은 시간이 소요될 수 있습니다.'] = '備份文件中若包含不正常字符時恢復將失敗，可以矯正不正常字符來還原資料.如果使用恢復將多需要點時間.';
$__text['백업파일에 포함된 비정상적인 글자를 교정합니다.'] = '矯正備份文件中的不正常字符';
$__text['백업파일을 가져오고 있습니다.'] = '正在讀取備份文件';
$__text['백업파일을 선택하십시오.'] = '請選擇備份文件';
$__text['백업파일을 올리고 있습니다.'] = '正在上傳備份文件';
$__text['백업파일을 읽어서 데이터를 복원합니다.<br />백업파일에 첨부파일이 포함되어 있으면 첨부파일도 자동으로 복원됩니다.<br />이전 버전으로부터의 데이터도 복원을 통해 가져올 수 있습니다.'] = '正在讀取備份文件恢復資料<br />如果備份文件上包含附件時，自動恢復包含的附件。<br /> 舊版本的備份文件也可以用於恢復。';
$__text['백업파일을 자신의 하드디스크로부터 직접 선택하여 데이터베이스를 복원합니다. 백업파일의 용량이 업로드 허용용량을 초과하지 않는지 주의하십시오.'] = '上傳備份文件來恢復資料,請注意文件大小不要超過空間允許的最大限制';
$__text['백업파일을 저장할 공간에 권한이 없습니다.'] = '保存資料文件的空間沒有權限';
$__text['백업파일을 확인하고 있습니다.'] = '正在確認備份文件';
$__text['백업파일의 %1번째 줄이 올바르지 않습니다.'] = '備份文件的第 %1 行錯誤';
$__text['백업파일의 크기가 업로드 허용 용량을 초과하는 경우, FTP 등을 이용하여 계정의 홈페이지에 직접 업로드한 후 이 파일의 위치를 지정하여 데이터베이스를 복원할 수 있습니다.'] = '若備份文件大小超過空間允許容量，可以通過FTP等工具直接上傳到空間然後指定文件地址來恢復資料.';
$__text['백업파일이 손상되었거나 가져올 수 없습니다.'] = '備份文件損壞或無法讀取';
$__text['백업파일이 올바르지 않습니다.'] = '備份文件錯誤';
$__text['버전 %1'] = '版本 %1';
$__text['버전'] = '版本';
$__text['버전업 체크를 위한 파일을 생성합니다. 지금 생성하시겠습니까?'] = '未更新版本建立文件，現在確認嗎？';
$__text['변경된 1차 블로그 주소로 이동합니다'] = '跳轉到新的一級網誌地址';
$__text['변경된 2차 블로그 주소로 이동합니다'] = '跳轉到新的二級網誌地址';
$__text['변경된 기본 블로그 도메인으로 이동합니다.'] = '跳轉到新的默認網站地址';
$__text['변경된 블로그 주소로 이동합니다'] = '跳轉到新的網站地址';
$__text['변경된 스타일이 아직 저장되지 않았습니다.\n저장하시겠습니까?'] = '修改的樣式未保存。\\n現在保存嗎？';
$__text['변경하고 있습니다.'] = '正在更新設置';
$__text['변경하기'] = '保存修改';
...
$__text['분류의 글 정보를 다시 계산해서 저장합니다.'] = '重新計算分類內文章數並保存';
$__text['분야'] = '開發領域';
...
$__text['블로그 공개 정책을 설정합니다'] = '設定網誌公開政策';
$__text['블로그 권한 설정 과정에서 오류가 발생하였습니다.'] = '設定網誌權限時發生錯誤。';
$__text['블로그 글을 한 쪽당 %1개 보여줍니다.'] = '每頁顯示 %1篇文章';
$__text['블로그 로고 및 파비콘'] = '網誌Icon圖片及Favicon';
$__text['블로그 로그인 암호가 초기화되었습니다. 이 이메일에 로그인할 수 있는 인증 정보가 포함되어 있습니다.'] = '網誌登入密碼已初始化,這封信件中包含可以登入後台的認證訊息.';
$__text['블로그 로그인 암호가 초기화되었습니다.'] = '成功初始化登入密碼.';
$__text['블로그 메인으로 이동합니다.'] = '跳轉到網誌首頁';
$__text['블로그 바로가기'] = '返回網誌';
$__text['블로그 설명'] = '網誌描述 ';
$__text['블로그 설명을 변경하지 못했습니다.'] = '未能修改網誌說明.';
$__text['블로그 설정 테이블과 사용자 설정 테이블의 구조를 변경합니다.'] = '變更網誌設定資料表和用戶設定資料表的結構。';
$__text['블로그 설정 테이블에 RSS 공개 정도 설정 필드를 추가합니다.'] = '為網誌設定資料庫中新增RSS公開程度資料表.';
$__text['블로그 설정 테이블의 시간대 필드 속성을 변경합니다.'] = '修改網誌設定資料庫中的時區資料表屬性.';
$__text['블로그 설정 테이블의 언어 필드 속성을 변경합니다.'] = '修改網誌設定資料庫中的語言資料表屬性.';
$__text['블로그 설정을 복원하고 있습니다.'] = '正在設定網誌設定.';
$__text['블로그 소유자'] = '網誌管理員';
$__text['블로그 소유자만 테이블을 관리할 수 있습니다.'] = '只有網誌管理員才能管理資料庫';
$__text['블로그 시간대를 변경할 수 없습니다.'] = '無法修改時區';
$__text['블로그 식별자'] = '網誌識別ID';
$__text['블로그 식별자가 올바르지 않습니다.'] = '網誌識別ID錯誤';
$__text['블로그 식별자는 영문으로 입력하셔야 합니다.'] = '網誌識別ID比必須為英文字母';
...
$__text['블로그 언어'] = '網誌語言';
$__text['블로그 언어를 변경할 수 없습니다.'] = '無法修改網誌語言.';
$__text['블로그 언어와 시간대를 변경할 수 없습니다.'] = '無法修改網誌語言及時區.';
$__text['블로그 정보'] = '網誌訊息';
$__text['블로그 정보를 보여주는 패널을 사용합니다'] = '顯示網誌訊息';
$__text['블로그 제목'] = '網誌名稱';
$__text['블로그 제목을 변경하지 못했습니다.'] = '未能修改網誌名稱';
$__text['블로그 주소 예시'] = '網誌地址例';
$__text['블로그 주소'] = '網誌地址';
$__text['블로그 주소(%s)를 관리자로 등록된 오픈아이디 중 하나에 위임하여 오픈아이디로 사용할 수 있습니다.'] = '在以管理員登入的OpenID可以把網誌地址委任為自己的OpenID地址來使用。';
$__text['블로그 주소가 올바르지 않습니다.'] = '網誌地址錯誤';
$__text['블로그 주소를 변경하지 못했습니다'] = '未能修改網誌地址';
$__text['블로그 주소를 오픈아이디로 사용'] = 'OpenID使用網誌地址';
$__text['블로그 주소를 오픈아이디로 사용하지 않습니다.'] = 'OpenID不使用網誌地址';
$__text['블로그 주소를 오픈아이디로 사용하지 않음'] = 'OpenID不使用網誌地址';
$__text['블로그 통계 정보를 복원하고 있습니다.'] = '正在恢復統計訊息';
$__text['블로그 표시설정'] = '網誌 顯示設定';
$__text['블로그 플러그인'] = '網誌插件';
$__text['블로그 화면으로'] = '到網誌首頁';
$__text['블로그'] = '網誌';
$__text['블로그/관리자 플러그인'] = '網誌/管理 插件';
$__text['블로그로 이동'] = '返回網誌';
$__text['블로그에 표시되는 값들을 변경합니다'] = '修改網誌內顯示資料';
$__text['블로그의 기본 정보를 설정합니다'] = '設定網誌基本訊息';
$__text['블로그의 사이드바 구성을 변경할 수 있습니다. 사이드바는 블로그 화면에서 양 옆이나 위아래에 표시되는 메뉴가 있는 부분을 말합니다. 사이드바에 새로운 요소를 추가/삭제할 수 있으며 자유로운 위치 이동을 할 수 있습니다.'] = '您可以變更側欄的結構。側欄是網誌頁面兩側或上下位置出現的各種訊息，您可以增加刪除側欄的各個要素。';
...
$__text['비정상적인 데이터를 교정합니다.<br />동적인 캐쉬 데이터는 재계산하여 저장합니다.'] = '矯正不正常資料.<br />重新計算動態緩存資料並保存.';
...
$__text['사이드바의 기능을 스킨 설정 상태로 초기화합니다.'] = '初始化側欄使其到模板默認狀態';
$__text['사이트 주소'] = '網站地址';
...
$__text['새로운 프로필 사진을 저장 했습니다.'] = '已經保存新的個人照片';
$__text['색동'] = '自定首頁';
$__text['서버에 <em>%1</em>에 저장된 백업파일이 있습니다. 삭제후 복원에는 이 파일을 이용하실 수 있습니다.'] = '主機上的 <em>%1</em>上存在備份文件. 可以使用此文件恢復資料.';
$__text['서버에 <em>%1</em>에 저장된 백업파일이 있습니다.'] = '主機上的 <em>%1</em>上存在備份文件.';
$__text['서버에 백업파일을 저장하여 복원에 사용할 수 있습니다.'] = '可以把資料文件保存在主機上，用做資料還原.';
$__text['서버에 저장'] = '保存到主機';
$__text['서버에 저장된 백업파일.'] = '主機上的備份文件.';
...
$__text['설정 테이블에 블로그 언어 설정을 위한 필드를 추가합니다.'] = '為網誌設定資料庫新增網誌語言設定相關資料表.';
$__text['설정 파일'] = '設定文件';
$__text['설정 파일: OK (경고: "%1" 파일을 덮어 쓰게 됩니다.)'] = '配置文件: OK (警告: 將覆蓋"%1" 文件.)';
$__text['설정'] = '設定';
$__text['설정을 변경했습니다.'] = '成功變更設定';
$__text['설정을 저장하고 있습니다.'] = '正在保存設定';
...
$__text['시간대'] = '時區';
$__text['식별자'] = '識別ID';
$__text['실제 블로그 사이드바에 사용되는 태그를 직접사용하는 모드입니다.'] = '直接使用網誌側欄使用的標籤的安全模式';
...
$__text['알림판'] = '公告板';
$__text['암호 초기화'] = '初始化密碼';
$__text['언어 및 시간대'] = '語言與時區';
$__text['언어'] = '語言';
$__text['언어, 시간대를 설정합니다'] = '語言 & 時區';
$__text['업데이트 주기'] = '更新周期';
$__text['업로드 중..'] = '正在上傳...';
$__text['업로드 중지'] = '停止上傳';
$__text['업로드'] = '上傳';
...
$__text['여기를 클릭하시면 로그인하여 암호를 변경하실 수 있습니다.'] = '點擊這裡可以登入網誌後台頁面並修改密碼.';
...
$__text['오른쪽 정렬'] = '靠右對齊';
$__text['오름차순'] = '按字母正向';
$__text['오픈아이디 기억'] = '保存OpenID';
$__text['오픈아이디 발급하기'] = '註冊OpenID';
...
$__text['오픈아이디 플러그인을 사용하고 있지 않으므로, 오픈아이디는 설정할 수 없습니다. 관리자에게 문의 하십시오'] = '因為沒有開啟OpenID插件，所以不能設定OpenID，請聯絡網誌管理員。';
$__text['오픈아이디'] = 'OpenID';
$__text['오픈아이디란?'] = 'OpenID是？';
//$__text['오픈아이디로 로그인을 해야만 댓글 및 방명록을 쓸 수 있습니다.'] = '';
//$__text['오픈아이디로 로그인하여 쓴 댓글/방명록에 오픈아이디 아이콘을 표시합니다.'] = '';
$__text['올바르지 않은 블로그 주소입니다'] = '錯誤的網誌地址';
...
$__text['완료.'] = '完成.';
$__text['완료되었습니다.'] = '已完成.';
$__text['외부 블로그에 표시되는 메세지의 언어를 설정합니다.<br />달력이나 댓글 입력창에 적용됩니다. 한국어 블로그를 운영하고 계신다면 한국어를 선택해 주십시오.'] = '設定網誌外部顯示語言.<br />適用於月曆，回覆視窗等. 若您是中文網誌使用者，請選擇中文.';
$__text['왼쪽 정렬'] = '靠左對齊';
$__text['요약'] = '簡約';
$__text['운영체제'] = '系統';
...
$__text['월요일'] = '一';
$__text['웹 설정 파일'] = '主機設定文件';
$__text['웹서버 설정에 <b>mod_rewrite</b>의 로딩이 포함되어야 합니다.'] = '主機設定中要包含 mod_rewrite 模塊';
$__text['웹서버 설정의 이 디렉토리에 대한 <em>AllowOverride</em> 항목에 <b>FileInfo</b>가 포함되거나 <b>All</b>이어야 합니다.'] = '主機設定中對本目錄的 AllowOverride 項目中應包含 FileInfo 或為 All.';
$__text['웹서버 설정의 이 디렉토리에 대한 <em>Options</em> 항목에 <b>FollowSymLinks</b>가 포함되거나 <b>All</b>이어야 합니다.'] = '主機設定中對本目錄的 Options 項目中應包含 FollowSymLinks或為 All.';
$__text['웹서버'] = '主機';
$__text['웹에서 백업파일 가져오기.'] = '從網路上讀取備份文件';
$__text['위 2와 3의 문제는 아래 내용을 웹서버 설정에 포함시켜 해결할 수 있습니다.'] = '以上問題中2和3可以在主機設定中包含以下內容來解決';
...
$__text['이 기능을 사용하면 올린 이미지의 크기를 줄여 저장하는 과정에서 서버에 무리를 줄 수 있으니 주의하시기 바랍니다.'] = '把圖片的尺寸縮小保存的過程中，會對伺服器帶來一定的壓力。';
...
$__text['이 사용자를 팀블로그에서 제외합니다.'] = '從團隊網誌中排除此用戶';
...
$__text['이미 사용중인 블로그 주소입니다'] = '已使用的網誌地址';
$__text['이미 존재하는 그룹 이름입니다.'] = '已存在的組名';
$__text['이미 존재하는 블로그 식별자입니다.'] = '已存在的網誌識別ID';
$__text['이미 존재하는 이메일입니다.'] = '已存在的信箱地址';
$__text['이미 존재하는 주소입니다.'] = '已存在的地址';
$__text['이미 존재하는 피드 주소입니다.'] = '已存在的FEED地址';
$__text['이미 팀원으로 등록된 사용자입니다.'] = '已登記的團隊網誌成員';
$__text['이미지 갤러리를 삽입합니다.'] = '插入圖片播放';
$__text['이미지 리샘플링 기능을 기본으로 사용합니다.'] = '默認使用圖片縮放';
$__text['이미지 리샘플링 정보'] = '圖片縮放訊息';
$__text['이미지 리샘플링을 설정합니다'] = '設定圖片縮放';
$__text['이미지 리샘플링을 통하여 올린 이미지의 크기를 줄여 저장한 후 출력하여 블로그의 트래픽을 줄여줍니다.'] = '通過圖片縮放，可以減少網誌的網路流量。';
$__text['이올린'] = 'Eolin';
...
$__text['참여중'] = '參與中';
$__text['참여중인 블로그'] = '我參與的網誌';
$__text['첨부 디렉토리'] = '附件目錄';
$__text['첨부 파일이 포함되지 않는 백업파일을 사용하여 복원하여도 기존 첨부 파일을 삭제하거나 훼손시키지 않습니다.'] = '使用包含附件的資料文件還原資料，也不會覆蓋或刪除原附件!';
$__text['첨부 파일이 포함된 백업파일을 사용하여 복원할 경우, 첨부 파일의 내용은 백업파일의 내용으로 다시 작성됩니다.'] = '使用包含附件的備份文件恢復資料時，附件文件會轉為備份文件.';
...
$__text['최근 댓글 길이'] = '最新評論長度';
$__text['최근 댓글 알리미'] = '最新評論通知';
$__text['최근 댓글'] = '最新評論';
...
$__text['최근에 걸린글'] = '最新引用';
$__text['최근에 달린 답글'] = '最新評論';
$__text['최근에 달린 댓글을 %1개 보여줍니다.'] = '最新評論顯示 %1個';
...
$__text['태그'] = '標籤';
$__text['태그관계 테이블의 인덱스를 수정합니다.'] = '修改標籤關係相關資料';
...
$__text['텍스트큐브 블로그 로그인 정보'] = 'Textcube 網誌登入訊息';
$__text['텍스트큐브 설치를 시작합니다.'] = '開始安裝Textcube';
$__text['텍스트큐브 시스템 점검이 필요합니다. 지금 점검하시겠습니까?'] = '需要系統檢查,現在就檢查嗎?';
$__text['텍스트큐브 주소'] = '網誌地址';
$__text['텍스트큐브 테이블을 삭제합니다'] = '刪除資料表';
$__text['텍스트큐브 홈페이지'] = 'Textcube主頁';
$__text['텍스트큐브 홈페이지로 이동합니다.'] = '到Textcube主頁';
...
$__text['텍스트큐브의 모든 데이터를 삭제합니다.<br />첨부파일의 삭제 여부를 선택하실 수 있습니다.<br />데이터의 복원은 백업파일을 통해서만 가능하므로 먼저 백업을 하시기 바랍니다.'] = '刪除所有Textcube資料。<br />可以選擇不刪除附件。<br />資料還原只能用備份文件進行還原,所以請先備份。';
$__text['토요일'] = '六';
$__text['통계와 관련된 구조를 변경합니다.'] = '修改統計相關資料結構.';
$__text['트리 속성'] = '屬性';
$__text['특징을 설정합니다'] = '設定特征訊息';
$__text['팀블로그 기능을 위한 테이블을 추가합니다.'] = '為團隊網誌，增加資料表';
$__text['팀블로그 정보를 설정합니다'] = '設定團隊網誌訊息';
$__text['팀블로그 제외'] = '排除於團隊網誌';
$__text['팀블로그 테이블의 사용자 이름 필드를 삭제합니다.'] = '刪除團隊網誌資料表中的用戶名字字段。';
$__text['팀블로그 테이블의 소유 관계를 정의합니다.'] = '定義團隊網誌資料表中的網誌所有關係';
$__text['팀블로그 테이블의 유저 출력 설정 필드를 삭제합니다.'] = '刪除團隊網誌資料表中的設定用戶顯示字段。';
$__text['팀블로그 테이블의 필드 이름을 변경합니다.'] = '變更團隊網誌資料表中的字段名';
$__text['팀블로그'] = '團隊網誌';
$__text['팀블로그를 관리합니다'] = '管理團隊網誌';
$__text['팀원 추가에 실패했습니다.'] = '增加成員失敗';
$__text['파비콘'] = 'Favicon';
$__text['파비콘은 웹 브라우저의 즐겨찾기나 주소 입력줄에 보이는 그림입니다.'] = 'Favicon是保存到書簽時顯示在地址前面的小圖片.';
...
$__text['하드웨어'] = '硬碟';
$__text['하위 경로(Path)로 블로그 식별'] = '按路徑(Path)識別網誌';
...
$__text['현재 상태의 데이터를 백업하여 다운로드합니다. 서버에 저장된 백업파일은 갱신되지 않습니다.'] = '備份並下載現在的資料，主機上的備份資料文件將不做更新.';
$__text['현재글 스크랩'] = '標記本文';
$__text['현재의 모든 데이터를 백업파일로 보관합니다.<br />첨부파일을 포함시킬 수 있으며, 복원할 경우 자동으로 첨부파일이 처리됩니다.<br />백업파일은 서버에 저장하거나 다운받으실 수 있습니다.'] = '把所有資料保存為備份文件格式.備份文件可以包含附件, 還原時會自動還原附件.備份文件可以保存在主機上,也可以下載到本地.';
$__text['홈페이지 이름'] = '網站名字';
$__text['홈페이지 제목'] = '網站標題';
$__text['홈페이지 주소'] = '網站地址';
