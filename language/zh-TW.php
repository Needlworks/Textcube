...
$__text["관리자"] = '管理';
$__text["글관리"] = '文章管理';
$__text["댓글 및 필자 정보에 사용되는 대표 홈페이지 주소를 설정합니다."] = "設定作者的訊息顯示代表的 URL。";
$__text["댓글"] = '回覆';
$__text["댓글의 댓글"] = "評論的回覆";
$__text["돌아가기"] = '返回';
$__text["방명록"] = "通訊錄";
$__text["방명록의 댓글"] = "通訊錄的回應";
$__text["보기"] = "部落格提升";
...
$__text["오픈아이디를 현재 계정에 연결합니다."] = "使用 OpenID 連結帳戶。";
...
//$__text['path'] = '';
$__text['rewrite 모듈을 사용하지 않습니다. 이 경우 단일 사용자 모드로만 동작하며, 글로 된 주소 체계(fancy-URL)를 사용할 수 없습니다.'] = 'Rewrite 設定無法使用。對於部落格運用規則僅能使用單人模式，且 fancy-URL 將無法使用。';
...
$__text['대표 주소'] = '代表位址';
$__text['대표 태그'] = '部落格標籤';
$__text['대표 태그를 변경하지 못했습니다.'] = '部落格標籤變更失敗。';
$__text['댓글 삭제'] = '刪除回覆';
...
$__text['댓글을 수정합니다.'] = '修改回覆.';
$__text['댓글을 오픈아이디 사용자에게만 허용할 수 있습니다.'] = '只有 OpenID 的使用者可以回覆';
...
$__text['블로그 주소'] = '部落格地址';
$__text['블로그 주소(%1)를 소유자 계정에 연결된 오픈아이디 중 하나에 위임하여 오픈아이디로 사용할 수 있습니다.'] = '委任一個使用者帳戶連結至部落格位址(%1)於 OpenID 中，並於 OpenID 中公開使用。';
...
$__text['소유자 계정에 연결된 오픈아이디 목록'] = '管理者用 OpenID';
$__text['소유자 계정에 연결된 오픈아이디가 없습니다'] = '非管理者用 OpenID';
$__text['소유자 계정에 오픈아이디 연결하기'] = '管理者權限賦予設定';
...
$__text['연결한 오픈아이디로 이 계정에 로그인 할 수 있습니다.'] = '以 OpenID 的管理者來署名';
$__text['연락처를 아는'] = '聯絡';
$__text['예'] = '例';
...
$__text['오픈아이디 로그인 목록'] = 'OpenID 登入歷史';
$__text['오픈아이디 로그인 사용자에게만 댓글을 허용하도록 설정하러 가기'] = '回覆權限設定';
...
/* Additional */
$__text['운영자만이 수정할 수 있습니다'] = '僅能修改操作者';

/* From JS */
/* byTextcube.js */
$__text['비밀번호를 입력하지 않으면 나중에 수정하실 수 없습니다.\t\n\n계속 진행하시겠습니까?'] = '若是不輸入密碼，則以後無法修改。\\t\\n\\n是否繼續？';
$__text['답글을 올리시겠습니까?'] = '送出回覆？\\t';
$__text['시각을 바르게 입력해 주십시오'] = '請輸入正確時間';

/* control.js */
$__text['새로운 사용자가 추가되었습니다.'] = '增加了新的使用者';
$__text['사용자를 추가하지 못했습니다.'] = '無法增加新的使用者';
$__text['새로운 블로그가 추가되었습니다.'] = '增加了新的引用';
$__text['블로그를 추가하지 못했습니다.'] = '無法增加新的引用';
$__text['모든 글과 블로그가 관리자의 소유로 옮겨집니다.'] = '擁有者的所有的文章與引用回覆將被清除。';
$__text['계속 진행하시겠습니까?'] = '是否要繼續進行？';
$__text['사용자 삭제에 실패하였습니다.'] = '使用者刪除失敗。';
$__text['사용자 삭제중'] = '使用者刪除中';

/* EAF4.js */
$__text['아직 처리중인 작업이 있습니다.'] = '目前仍持續運作中。';

/* editor3.js */
$__text['이 편집기에서는 iMazing 갤러리를 지원하지 않습니다.'] = '此編輯模式不支援 iMazing 圖片撥放器。';
$__text['이 편집기에서는 주크박스를 지원하지 않습니다.'] = '此編輯模式不支援 JukeBox.';
$__text['파일 리스트에서 이미지를 2개 선택해 주십시오. (ctrl + 마우스 왼쪽 클릭)'] = '請在檔案清單中選擇 2 個圖片檔案(ctrl + 滑鼠左鍵)';
$__text['파일 리스트에서 이미지를 3개 선택해 주십시오. (ctrl + 마우스 왼쪽 클릭)'] = '請在檔案清單中選擇 3 個圖片檔案(ctrl + 滑鼠左鍵)';
$__text['이미지 파일만 삽입 가능합니다.'] = '只能插入圖片檔案。';
$__text['iMazing 갤러리는 JPG,PNG,GIF 파일만 지원됩니다\n그 외의 형식은 목록에서 제외했습니다'] = 'iMazing 撥放器只支援 JPG, PNG, GIF 格式檔案\\n其餘檔案將不被支援。';
$__text['MP3 파일만 삽입 가능합니다.'] = '只能插入 MP3 檔案。';

/* pluginconfig.js */
$__text['objList 가 정의 안됨'] = 'objList 沒有被定義';
$__text['type에 접근 안됨'] = 'type 沒有被定義';

/* /plugin/FM_Modem/editor.js */
