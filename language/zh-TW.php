...
$__text["관리자 권한이 없는 오픈아이디 입니다"] = '寫入署名的 OpenID, 不被採用管理員權利。';
$__text["관리자"] = '管理';
$__text["글관리"] = '文章管理';
...
$__text["오픈아이디(%1)로 작성하였습니다"] = '製作了 OpenID(%1)';
...
$__text["위로"] = '向上';
$__text["이 블로그에 오픈아이디로 로그인하여 글을 남긴 사람들의 기록입니다."] = '將使用 Open ID 登入的使用者紀錄於此清單中.';
//$__text["이미 확인한 메일"] = "";
//$__text["인증 성공"] = "";
//$__text["인증 실패"] = "";
$__text["인증이 취소되었습니다."] = '認證已被取消。';
$__text["인증하지 못하였습니다. 아이디를 확인하세요"] = '無法登入，請您再確認ID';
$__text["임시 암호가 설정되어 있습니다."] = '選擇設置密碼';
//$__text["접속 성공"] = "";
//$__text["접속 실패"] = "";
//$__text["첨부"] = "";
//$__text["총 %d개의 메시지"] = "";
...
$__text['RSS를 변경할 수 없습니다.'] = 'RSS位址變更失唄。';
...
$__text['검색 시'] = '搜索時';
$__text['검색'] = '搜索';
$__text['검색엔진이 링크 관계를 인식할 수 있도록 링크에 FOAF를 추가합니다.'] = '為了讓搜尋引擎識別 FOAF,在鏈結中追加 rel="FOAF"';
$__text['경과'] = '經過';
...
$__text['등록'] = '登入';
$__text['등록되지 않은 소유자 E-mail 입니다.'] = '沒有此 E-mail Address';
...
$__text['밑줄'] = '下劃線';
$__text['바깥 글 읽기'] = '閱讀器';
$__text['바깥글 보기 (RSS 리더)를 사용합니다. 끌 경우 리더가 RSS를 읽어오는 로드가 줄어들기 때문에 서버 로드가 줄어듭니다.'] = '在發布 RSS 時使用簡短內文發送, 可減低服務器壓力.';
$__text['바로 가기'] = '開始';
$__text['바로가기'] = '轉到';
$__text['받는 사람'] = '收件人';
...
$__text['새로운 비밀번호'] = '新密碼';
$__text['새로운 사람을 블로그의 필자로 초대합니다. 초대장은 이메일을 통하여 발송됩니다. 메일 주소가 이미 블로그 서비스에 등록되어 있는 경우, 그 사용자에게 이 블로그의 필진 권한을 추가합니다. 사용자가 존재하지 않는 경우에는 새로운 사용자를 자동으로 등록하고 초대장을 발송합니다. 초대된 사람에게는 기본적으로 글쓰기 권한이 부여됩니다.'] = '填寫邀請函, 透過電子郵件發給新的成員. 並會將成員資訊與權限紀錄於郵件當中一併傳送. 成員點擊邀請函中的網址即可加入團隊部落格.';
...
$__text['에디터에서 다중 파일 업로드를 지원하는 플래시 업로더를 사용합니다.'] = '在編輯模式時使用 Flash 的檔案上傳. 支援多重檔案上傳.';
...
$__text['이 계정은 %1에 생성되었습니다.'] = '此運算應用於 %1';
...
$__text['이 블로그는 대표 블로그입니다.'] = 'Top Blog';
...
$__text['켜짐'] = '開啟';
$__text['크기'] = '大小';
$__text['크로스 브라우징을 지원하는 트랙백 복사를 위한 플래시를 사용합니다.'] = '使用支援 Flash 的裁切模式.';
$__text['클릭 설정'] = '點擊設定';
$__text['키로그'] = '關鍵字清單';
$__text['키워드 통계'] = '關鍵字統計';
$__text['키워드'] = '關鍵字';
...
$__text['프로필 사진'] = '個人照片';
$__text['플래시 업로더 사용'] = '使用 Flash uploader';
$__text['플래시 트랙백 주소 복사 사용'] = '使用 Flash clipboard';
$__text['플러그인 관리'] = '管理插件';
