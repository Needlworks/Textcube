...
$__text["아래로"] = '向下';
$__text["오픈ID를 입력하세요"] = '請您輸入網路實名';
$__text["오픈아이디(%s)로 작성하였습니다"] = '通過網路實名（%s）編輯成功';
...
$__text['2차 블로그 주소가 비어있어서 기본 블로그 주소로 설정할 수 없습니다'] = '沒有填寫二級部落格地址,不能設定為默認部落格地址';
...
//$__text['ACO / ACL / i18n / XML-RPC API interface / 網路實名'] = '';
...
//$__text['Maintainer'] = '';
$__text['MetaWeblog API나 Blogger API를 이용하여 글을 작성할 수 있도록 합니다.'] = '在支援 MetaWeblog API Blogger API 的環境下 ，可使用此功能發佈部落格';
...
$__text['관리자 계정과 연결된 오픈아이디'] = '與管理者帳戶關聯的網路實名';
...
$__text['관리자만 볼 수 있는 댓글입니다'] = '只有管理者可以看的回覆';
$__text['관리자만 볼 수 있는 댓글입니다.'] = '只有管理員能看到的回覆.';
$__text['관리자만 볼 수 있는 방명록입니다.'] = '只有管理者可以看的留言板';
$__text['관리자의 설정에 의해 오픈아이디로 로그인한 사용자만 댓글을 남길 수 있습니다'] = '按照管理者的設定，只有使用網路實名登入的用戶才可以寫評論。';
$__text['관리자의 설정에 의해 오픈아이디로 로그인한 사용자만 댓글을 남길 수 있습니다.\r\n로그인하시겠습니까?'] = '按照管理者的設定，只有使用網路實名登入的用戶才可以寫評論。\\r\\n要登入嗎?';
...
$__text['다음'] = '繼續';
$__text['다중 사용자 모드로 설치된 경우 블로그 관리자는 표지 기능을 이용하여 대표 블로그를 다른 블로그들에 대한 센터 기능을 하도록 구성할 수 있습니다.'] = '設定為團隊使用者模式時,部落格管理者可利用首頁功能,將代表性的文章架構成其他部落格的中心功能';
$__text['다중 사용자'] = '多用戶';
$__text['단일 블로그'] = '單一用戶';
$__text['단일 사용자'] = '單一使用者';
$__text['단축키'] = '熱鍵';
...
$__text['블로그 설정 테이블의 언어 필드 속성을 변경합니다.'] = '修改部落格設定資料庫中的語言資料表屬性.';
...
$__text['블로그 식별자는 영문으로 입력하셔야 합니다.'] = '部落格識別ID必須為英文字母';
...
$__text['블로그 언어'] = '部落格語言';
$__text['블로그 언어를 변경할 수 없습니다.'] = '無法修改部落格語言.';
$__text['블로그 언어와 시간대를 변경할 수 없습니다.'] = '無法修改部落格語言及時區.';
$__text['블로그 정보'] = '部落格訊息';
...
$__text['블로그 주소'] = '部落格地址';
$__text['블로그 주소(%s)를 관리자로 등록된 오픈아이디 중 하나에 위임하여 오픈아이디로 사용할 수 있습니다.'] = '在以管理員登入的網路實名可以把部落格地址委任為自己的網路實名地址來使用。';
$__text['블로그 주소가 올바르지 않습니다.'] = '部落格地址錯誤';
$__text['블로그 주소를 변경하지 못했습니다'] = '未能修改部落格地址';
$__text['블로그 주소를 오픈아이디로 사용'] = '網路實名使用部落格地址';
$__text['블로그 주소를 오픈아이디로 사용하지 않습니다.'] = '網路實名不使用部落格地址';
$__text['블로그 주소를 오픈아이디로 사용하지 않음'] = '網路實名不使用部落格地址';
...
$__text['블로그의 표지 구성을 변경할 수 있습니다.'] = '可變更部落格的首頁架構';
$__text['비공개 글'] = '未公開文章';
$__text['비공개'] = '不公開';
...
$__text['삭제'] = '刪除';
$__text['삭제: 오픈아이디에 부과된 관리자 권한을 제거합니다.'] = '刪除:解除與網路實名關聯的管理員權限。';
...
$__text['선택된 모듈을 표지에 추가합니다.'] = '將選擇的模組追加到首頁';
...
$__text['설정 테이블에 블로그 언어 설정을 위한 필드를 추가합니다.'] = '為部落格設定資料庫新增部落格語言設定相關資料表.';
$__text['설정 파일'] = '設定文件';
...
$__text['실제 블로그 표지에 사용되는 태그를 직접사용하는 모드입니다.'] = '可直接使用標籤(使用於實際部落格首頁)的模式';
...
$__text['오른쪽 정렬'] = '靠右對齊';
$__text['오름차순'] = '按字母正向';
$__text['오픈아이디 기억'] = '保存網路實名';
$__text['오픈아이디 발급하기'] = '註冊網路實名';
$__text['오픈아이디 사용현황'] = '網路實名 使用狀況';
$__text['오픈아이디 인증 플러그인을 활성화하십시오'] = '請啟動網路實名認證插件';
$__text['오픈아이디 저장'] = '保存網路實名';
$__text['오픈아이디 주소(이름)'] = '網路實名 地址（名字）';
$__text['오픈아이디 플러그인 설정 바로가기'] = '轉到網路實名插件設定頁面';
$__text['오픈아이디 플러그인을 사용하고 있지 않으므로, 오픈아이디는 설정할 수 없습니다. 관리자에게 문의 하십시오'] = '因為沒有開啟網路實名插件，所以不能設定網路實名，請聯絡部落格管理員。';
$__text['오픈아이디'] = '網路實名';
$__text['오픈아이디란?'] = '網路實名是？';
$__text['오픈아이디로 로그인을 해야만 댓글 및 방명록을 쓸 수 있습니다.'] = '需使用網路實名登入才能編輯回覆及留言板';
$__text['오픈아이디로 로그인하여 쓴 댓글/방명록에 오픈아이디 아이콘을 표시합니다.'] = '在使用網路實名登入後所編輯的回覆/留言板上,標示網路實名圖像';
...
$__text['완료.'] = '完成.';
$__text['완료되었습니다.'] = '已完成.';
$__text['외부 블로그에 표시되는 메세지의 언어를 설정합니다.<br />달력이나 댓글 입력창에 적용됩니다. 한국어 블로그를 운영하고 계신다면 한국어를 선택해 주십시오.'] = '設定部落格外部顯示語言.<br />適用於月曆，回覆視窗等. 若您是中文部落格使用者，請選擇中文.';
$__text['왼쪽 정렬'] = '靠左對齊';
$__text['요약'] = '簡約';
$__text['운영체제'] = '系統';
...
$__text['이 표지 모듈을 삭제합니다.'] = '刪除此首頁模組';
$__text['이 표지 모듈을 아래로 이동합니다.'] = '將此首頁模組往下移';
$__text['이 표지 모듈을 위로 이동합니다.'] = '將此首頁模組往上移';
...
$__text['임시 저장본을 보시겠습니까?'] = '要查看臨時保存的文章嗎?';
...
$__text['정말 표지의 기능을 초기화하시겠습니까?'] = '確定要進行首頁功能的初始化嗎?';
$__text['정보 가져오기'] = '讀取資料';
...
$__text['태그와 태그 관계 정보를 다시 계산해서 저장합니다.'] = '將標籤與標籤關連資訊重新計算後儲存';
...
$__text['표지 설정으로 바로가기'] = '前往首頁設定';
$__text['표지 플러그인'] = '首頁插件';
$__text['표지'] = '首頁';
$__text['표지는 블로그 첫 화면 또는 %1/cover 에 표시되는 부분입니다.'] = '首頁為部落格的第一個畫面或標示於%1/cover的部分';
$__text['표지를 관리합니다'] = '首頁管理';
$__text['표지를 첫 화면으로 사용합니다'] = '將首頁設定為第一個使用畫面';
$__text['표지에 새로운 요소를 추가/삭제할 수 있으며 패널들을 자유롭게 배치 할 수 있습니다.'] = '可追加/刪除首頁新元素,並可自由排列PANEL';
$__text['표지의 기능을 스킨 설정 상태로 초기화합니다.'] = '將首頁功能初始化為SKIN設定狀態';
$__text['표지의 위치는 스킨의 구조에 따라 달라집니다.'] = '首頁的位置會隨著SKIN構造產生變化';
