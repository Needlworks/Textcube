...
$__text['또는 새로운 분류를 추가합니다.'] = '新分類增加成功';
$__text['또는'] = '執行';
$__text['또다른나'] = '屬於自己';
$__text['라이센스'] = '版權';
$__text['로고 그림'] = 'Icon圖片';
...
$__text['만든이'] = '作者';
$__text['만들기'] = '新增';
$__text['만약 rewrite 모듈 설정을 올바르게 했는데도 모듈 사용 여부의 검사에 문제가 있는 경우 rewrite 모듈을 사용하지 않음을 선택하시고 이 부분을 건너 뛰시기 바랍니다.'] = '若無發現任何錯誤訊息卻依舊有錯誤發生時, 請解除 rewrite 的使用. 在系統設定中可以解除.';
$__text['매력적인'] = '魅力的';
$__text['머리말'] = '標題';
