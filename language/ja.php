...
$__text['공개'] = '公開';
$__text['공개된 글'] = '公開記事';
$__text['공개된 모든 글을 <acronym title="Rich Site Summary">RSS</acronym>로 내보냅니다.'] = '公開記事の全てを<acronym title="Rich Site Summary">RSS</acronym>フィードとして公開';
...
$__text['글 주소'] = '固定リンク';
$__text['글 테이블의 편집기와 포매터 필드를 갱신합니다.'] = '記事テーブルのエディターやフォーマットテーブルを更新します。';
$__text['글'] = '記事';
...
$__text['다시 설정하시려면 config.php를 먼저 삭제하셔야 합니다.'] = 'リセットするためにはまずconfig.phpファイルを削除してください。';
$__text['다운로드'] = 'ダウンロード';
...
$__text['다음'] = '次へ';
$__text['다중 사용자 모드로 설치된 경우 블로그 관리자는 표지 기능을 이용하여 대표 블로그를 다른 블로그들에 대한 센터 기능을 하도록 구성할 수 있습니다.'] = '多重利用者モードでは最高管理者はトップブログを全体ブログへのメタページに構成できます。';
$__text['다중 사용자'] = '多重利用者';
$__text['단일 블로그'] = '単一ブログ';
$__text['단일 사용자'] = '単一利用者';
...
$__text['라이센스'] = 'ライセンス';
$__text['로고 그림'] = '個人画像設定';
$__text['로고를 변경하였습니다.'] = '個人画像設定を変更しました。';
$__text['로고를 변경하지 못했습니다.'] = '個人画像設定の変更に失敗しました。';
...
$__text['블로그 API 용 비밀번호'] = 'ブログAPI用のパスワード';
...
$__text['블로그 로고 및 파비콘'] = '個人画像・Favicon設定';
...
$__text['블로그'] = 'ブログ';
$__text['블로그/관리자 플러그인'] = 'ブログ・管理者用プラグイン';
...
$__text['삭제되는 기존 사용자의 글은 전부 관리자의 글로 변환됩니다.'] = '除名対象メンバーの記事は最高管理者の記事に変更されます。';
...
$__text['스킨 관련 테이블에 댓글 및 글걸기 메세지 설정을 위한 필드를 삭제합니다.'] = 'スキンテーブルからコメントやトラックバック設定フィールドを削除します。';
...
$__text['스킨 설정 테이블에 저자별 페이지 출력 설정을 위한 필드를 추가합니다.'] = 'スキン設定テーブルに投稿者情報ページの出力設定のため新規フィールドを作成します。';
...
$__text['스킨 테이블의 필드 이름을 변경합니다.'] = 'スキンテーブルのフィールド名称を更新します。';
$__text['스킨 편집'] = 'スキン編集';
$__text['스킨'] = 'スキン';
...
$__text['이 블로그의 구성원만 접근할 수 있도록 합니다.'] = 'チームメンバのみ';
...
$__text['이올린에 발행된 글만을 RSS로 내보냅니다.'] = '発行記事のみをRSSフィードとして公開';
...
$__text['환경'] = '環境';
$__text['환경설정'] = '環境設定';
$__text['환경설정-계정 정보에서 API key를 설정하시면 온라인 복원을 위한 주소를 만들 수 있습니다.'] = '環境設定>アカウント情報からAPIキーを設定するとブログの遠隔復元URLが作成できます。';
...
$__text['휴지통 비우기'] = '全件削除';
$__text['휴지통 테이블의 필드 속성을 변경합니다.'] = 'コミ箱テーブルのフィールド属性を更新します。';
$__text['휴지통'] = 'コミ箱';
