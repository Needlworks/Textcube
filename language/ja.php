...
$__text['"%1"에 %2 디렉토리를 생성할 수 없습니다. "%1"의 퍼미션을 %3(으)로 수정해 주십시오.'] = '"%1"に %2 フォルダを作成できません。"%1"のパーミッションを %3に更新してください。';
...
$__text['%1 에 달린 트랙백'] = '%1に転送されたトラックバック';
$__text['%1 전'] = '%1の前';
$__text['%1 제작'] = '%1製作';
...
$__text['Microformat-info: class="author"를 사용한 스킨입니다. hAtom용 author는 삽입하지 않았습니다. 주의: 스킨에 사용된 author의 용도가 마이크로포맷과 다를 수 있습니다.'] = 'Microformat-info: 利用中のスキンは class=\"author\"属性を含んでいます。hAtom用の author属性は除かれます。注意：スキンが含んだ author属性は標準属性と相異する可能性があります。';
...
$__text['Microformat-info: 스킨에 class="hentry"가 있으므로, hAtom용 entry는 삽입하지 않았습니다.'] = 'Microformat-info: 利用中のスキンは既に class="hentry"属性を含んでいるため、hAtom用の entry属性は除かれます。';
$__text['Microformat-info: 스킨에 가능한 모든 마이크로포맷을 추가합니다.'] = 'Microformat-info: 利用中のスキンから全てのマイクロフォーマットを利用します。';
...
$__text['Microformat-info: 작성자가 출력되지 않는 스킨입니다. 작성자를 보이지 않게 추가하였습니다.'] = 'Microformat-info: 利用中のスキンは作成者属性を支援しておりません。作成者属性を非表示に転換しました。';
...
$__text['RSS 공개 범위를 변경하지 못했습니다.'] = 'RSSフィードの公開設定更新に失敗しました。';
$__text['RSS 공개 정도'] = 'RSSフィード公開設定';
$__text['RSS 공개 정도를 변경할 수 없습니다.'] = 'RSSフィード公開設定更新に失敗しました。';
$__text['RSS 글 개수를 변경하지 못했습니다.'] = 'RSSフィードの記事数設定の更新に失敗しました。';
...
$__text['RSS를 변경할 수 없습니다.'] = 'RSSアドレスの更新に失敗しました。';
...
$__text['글 종류'] = '記事タイプ';
$__text['글 주소 표기법을 변경할 수 없습니다.'] = '固定リンクの表記方法の更新に失敗しました。';
$__text['글 주소'] = '固定リンク';
...
$__text['기본 스킨을 변경합니다.'] = 'デフォルトスキンを更新します。';
...
$__text['블로그 API는 MovableType 혹은 MetaWeblog API를 선택하시면 됩니다.'] = 'ブログAPIのタイプは MovableType 或いは MetaWeblog APIに設定してください。';
$__text['블로그 ID'] = 'ブログID';
...
$__text['블로그 주소(%1)를 소유자 계정에 연결된 오픈아이디 중 하나에 위임하여 오픈아이디로 사용할 수 있습니다.'] = 'ブログアドレス(%1)をOpenIDアカウントとして利用できます。(管理者権限付与設定)';
$__text['블로그 주소'] = 'URL';
...
$__text['스킨 설정을 복원하고 있습니다.'] = 'スキン設定を復元中…';
...
$__text['외부 주소'] = 'URL入力';
$__text['외부 편집기가 사용할 수 있는 주소를 만들어 주는 <b>도우미</b>입니다.'] = 'BlogAPIを利用するエディターから利用するAPIアドレスを作成する<strong>BlogAPIマネジャー</strong>です。';
$__text['왼쪽 정렬'] = '左揃え';
$__text['요약'] = '要約統計';
...
$__text['피드를 삭제하고 있습니다.'] = 'RSSフィードを削除中…';
$__text['피드를 삭제했습니다.'] = 'RSSフィードを削除しました。';
$__text['피드를 수정하고 있습니다.'] = 'RSSフィードを更新中…';
$__text['피드를 수정하였습니다.'] = 'RSSフィードを更新しました。';
