...
$__text['댓글, 걸린글(트랙백) 및 통합 RSS의 글은 최신 %1개로 갱신됩니다'] = '更新範囲は最新の %1 件のコメント, トラックバック, 統合RSSで設定';
...
$__text['모든 글'] = '全体記事';
$__text['모든 글과 블로그가 관리자의 소유로 옮겨집니다.'] = '除名対象メンバーの全ての権限は最高管理者がお持ちすることになります。';
...
$__text['변경하고자 하는 비밀번호 또는 API키를 입력해 주십시오.'] = '変更しようとするパスワード、またはAPIキーをご入力ください。';
$__text['변경하기'] = '変更';
...
$__text['블로그 주소(%s)를 소유자 계정에 연결된 오픈아이디 중 하나에 위임하여 오픈아이디로 사용할 수 있습니다.'] = 'ブログアドレス(%s)をOpenIDアカウントとして利用できます。(管理者権限付与設定)';
$__text['블로그 주소'] = 'URL';
...
$__text['사용중인 스킨이 표지를 지원하지 않습니다.'] = '利用中のスキンがメタページを支援しておりません。';
$__text['사용중인 표지 플러그인이 없습니다.'] = 'メタページプラグインを利用しておりません。';
...
$__text['이 계정은 %s에 생성되었습니다.'] = '%sに作成されたアカウント';
...
$__text['자세히 보기'] = '詳細情報';
$__text['자투리는 조각보에 기능을 추가합니다. 이 곳에서 자투리들의 사용 여부를 결정할 수 있습니다.'] = 'ウィジェットでダッシュボードの機能追加ができます。ここからウィジェットの利用可否を設定します。';
