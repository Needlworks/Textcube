...
$__text['플러그인 설정 데이터를 모두 초기화 합니다. 사용중인 모든 플러그인을 미사용으로 초기화 한다는 의미입니다.<br />플러그인 설정 데이터의 복원은 백업파일로만 가능하므로 먼저 백업을 하시기 바랍니다.'] = '全体設定データをリセットします。利用中のプラグインは全部利用中止に転換されます。<br />データの復元はバックアップだけでできますので必ずバックアップをしてください。';
...
$__text["외부 편집기가 사용할 수 있는 주소를 만들어 주는 <b>도우미</b>입니다."] = 'BlogAPIを利用するエディターから使えるAPIアドレスを作成する<strong>BlogAPIマネジャー</strong>です。';
$__text["위로"] = '上段へ';
$__text["인증이 취소되었습니다."] = '認証が取り消されました。';
$__text["인증하지 못하였습니다. 아이디를 확인하세요"] = '認証に失敗しました。IDを確認してください。';
$__text["임시 암호가 설정되어 있습니다."] = 'パスワードが任意で設定されています。';
//$__text["팀원 추가"] = "";
$__text["편집기에 미리 정한 분류로 글을 보내는 기능이 없거나, 글들을 일괄적으로 하나의 분류로 작성하고자 할 때 이 도우미를 사용해서 주소를 만든 후 복사해서 사용하시기 바랍니다."] = 'エディターから分類設定を支援していない場合と記事の分類を一括的で設定しようとするとマネジャーからAPIアドレスを作成してご利用ください。';
...
$__text['Body id는 블로그 스킨의 <acronym title="Cascading Style Sheet">CSS</acronym> 활용을 위해 사용합니다.<br /> 기본값인 "tt-body-category"를 그냥 사용하셔도 사용에 지장은 없습니다.'] = 'Body IDは<acronym title="Cascading Style Sheet">CSS</acronym>シートの多様な活用のために存在します。<br /> デフォールトの "tt-body-category"のままでおいてもブログの利用に差支えはありません。';
...
$__text['RSS 주소를 입력해서 링크할 홈페이지의 정보를 읽어올 수 있습니다. 수동으로 제목과 주소를 입력하셔도 됩니다.'] = 'RSSフィードを入力してブックマークするサイトの情報を取得できます。タイトルやURLを直接入力してもよろしいです。';
$__text['RSS 파일의 글 본문은 %1를 원칙으로 합니다.'] = 'RSSフィードの記事本文は %1 を原則とします。';
$__text['RSS 파일의 블로그 글은 최신 %1개로 갱신됩니다.'] = 'RSSフィードの記事は最新の %1 件で更新します。';
$__text['RSS를 변경할 수 없습니다.'] = 'RSSアドレスの変更に失敗しました。';
...
//$__text['path'] = '';
$__text['rewrite 모듈을 사용하지 않습니다. 이 경우 단일 사용자 모드로만 동작하며, 글로 된 주소 체계(fancy-URL)를 사용할 수 없습니다.'] = 'Rewriteモジュールを利用しません。この場合にブログの運用ルールは単一利用者モードしか運用ができません、そしてfancy-URL機能が動作できません。';
...
$__text['갱신'] = '更新';
$__text['거부'] = '拒否';
$__text['걸린 글 데이터를 교정하고 있습니다.'] = 'トラックバックデータを校正しております。';
...
$__text['그룹을 추가하고 있습니다.'] = 'グループを作成しております。';
...
$__text['글 버전 관리및 비교를 위한 테이블을 추가합니다.'] = '記事の管理やバージョン比較のための新規テーブルを作成します。';
$__text['글 보관함'] = 'アーカイブ';
$__text['글 수 출력'] = '記事数表示';
...
$__text['글을 걸고 있습니다.'] = 'トラックバック転送中…';
$__text['글을 걸었습니다.'] = 'トラックバック転送に成功しました。';
...
$__text['다른 사람의 블로그에 단 댓글에 대한 댓글이 등록되면 알려줍니다. 알리미가 동작하기 위해서는 댓글 작성시 홈페이지 기입란에 자신의 블로그 주소를 입력하셔야 합니다.'] = '他人のブログに作成したコメントに返信コメントが作成されるとお知らせします。コメントトラッカーの正常的な利用のためにはコメント作成時にURLの入力を必要とします。';
//$__text['다시 설정하시려면 config.php/.htaccess를 먼저 삭제하셔야 합니다.'] = '';
$__text['다운로드'] = 'ダウンロード';
...
$__text['다음'] = '次へ';
$__text['다중 사용자 모드로 설치된 경우 블로그 관리자는 표지 기능을 이용하여 대표 블로그를 다른 블로그들에 대한 센터 기능을 하도록 구성할 수 있습니다.'] = '多重利用者モードでは管理者はトップブログを全体ブログへのメタページに構成できます。';
$__text['다중 사용자'] = '多重利用者';
$__text['단일 블로그'] = '単一ブログ';
$__text['단일 사용자'] = '単一利用者';
...
$__text['답글 보기'] = 'コメント表示';
$__text['답글쓰기가 차단됐습니다.'] = 'コメント作成がブロックしております。';
...
$__text['대표 태그'] = 'ブログタグ';
$__text['대표 태그를 변경하지 못했습니다.'] = 'ブログタグの変更に失敗しました。';
$__text['댓글 RSS 파일의 블로그 글은 최신 %1개로 갱신됩니다.'] = 'コメントRSSフィードの記事は最新の %1件で更新します。';
$__text['댓글 삭제'] = 'コメント削除';
...
$__text['댓글'] = 'コメント';
$__text['댓글, 걸린글, 리퍼러가 입력될 때 아래의 단어가 포함되어 있으면 알림창을 띄우고 휴지통으로 보냅니다.'] = 'コメント、トラックバック、リファラがの入力時に下の単語を含めるとポップアップメッセージを出力してコミ箱へ転送します。';
...
$__text['또다른나'] = '自分所有';
$__text['라이센스'] = 'ライセンス';
$__text['로고 그림'] = 'ブログ代表画像';
$__text['로고를 변경하였습니다.'] = 'ブログ画像を変更しました。';
$__text['로고를 변경하지 못했습니다.'] = 'ブログ画像の変更に失敗しました。';
$__text['로고를 초기화 하였습니다.'] = 'ブログ画像をリセットしました。';
$__text['로고를 초기화합니다.'] = 'ブログ画像リセット';
$__text['로그아웃'] = 'サインアウト';
...
$__text['링크를 복원하고 있습니다.'] = 'ブックマークを復元しております。';
$__text['링크를 삭제하고 있습니다.'] = 'ブックマークを削除しております。';
$__text['링크를 삭제하시겠습니까?'] = 'ブックマークを削除しますか？';
$__text['링크를 수정하고 있습니다.'] = 'ブックマークを編集しております。';
$__text['링크를 추가하고 있습니다.'] = 'ブックマークを作成しております。';
//$__text['마지막 댓글로 채우기'] = '';
$__text['마지막 로그인'] = '最近接続';
$__text['만나는'] = 'お知り合い';
...
$__text['블로그 API 사용 여부'] = 'ブログAPIの利用可否';
...
$__text['블로그 아이콘'] = 'アイコン';
$__text['블로그 아이콘은 댓글과 방명록에서 사용됩니다. 크기는 16×16 이상, 48×48 이하까지 지원합니다.'] = 'アイコンはコメントや掲示板から利用します。<br />サイズは16x16から48x48(Pixel)までにしてください。';
...
$__text['블로그 주소'] = 'URL';
$__text['블로그 주소(%s)를 소유자 계정에 연결된 오픈아이디 중 하나에 위임하여 오픈아이디로 사용할 수 있습니다.'] = 'ブログアドレス(%s)をOpenIDアカウントとして利用できます。(管理者権限アカウント限定)';
...
$__text['블로그에 표시되는 값들을 변경합니다'] = '出力設定';
...
$__text['사용 불가능한 판번호'] = '利用不可のバージョン';
$__text['사용가능한 스킨 목록입니다'] = 'スキン一覧';
$__text['사용여부'] = '利用可否';
//$__text['사용자 ID'] = '';
//$__text['사용자 로고'] = '';
//$__text['사용자 삭제'] = '';
...
$__text['사용자'] = 'メンバー';
$__text['사용중'] = '利用中';
$__text['사용중이 아닌 플러그인/모듈'] = '利用していないプラグイン・モジュール';
$__text['사용중인 스킨이 사이드바 기능을 지원하지 않습니다.'] = '利用中のスキンがサイドバーを支援しておりません。';
$__text['사용중인 플러그인'] = '利用中のプラグイン';
$__text['사용중인 플러그인/모듈'] = '利用中のプラグイン・モジュール';
$__text['사용하지 않는 플러그인'] = '利用していないプラグイン';
...
$__text['삭제되는 기존 사용자의 글은 전부 관리자의 글로 변환됩니다.'] = '削除対象のメンバーの記事は管理者の記事となります。';
...
$__text['선택된 목록을 필터링에서 제외합니다. 계속 하시겠습니까?'] = '選択した項目を拒否リストから除外します、よろしいですか？';
...
$__text['스킨 및 트리, 플러그인의 저작권은 각 제작자에게 있습니다.'] = 'スキン、分類ツリーやプラグインの著作権はそれぞれの製作者がお持ちしております。';
$__text['스킨 변경'] = 'スキン変更';
$__text['스킨 선택'] = 'スキン選択';
...
$__text['스킨을 변경합니다'] = 'スキン変更';
$__text['스킨을 편집합니다 : "%1"'] = 'スキン編集 : "%1"';
$__text['스팸 필터'] = '拒否設定';
$__text['슬래시가 들어간 카테고리 이름은 사용할 수 없습니다'] = '分類名から半角スラッシュ(/)を除いてください。';
$__text['시간'] = '時間';
$__text['시간대'] = 'タイムゾーン';
//$__text['시스템'] = '';
$__text['식별자'] = '識別子';
...
$__text['오픈아이디 플러그인을 사용하고 있지 않으므로, 오픈아이디는 설정할 수 없습니다. 관리자에게 문의 하십시오'] = 'OpenIDプラグインを利用していないため、関連設定ができません。管理者に問い合わせてください。';
$__text['오픈아이디'] = 'OpenID';
$__text['오픈아이디란?'] = 'OpenIDとは？';
//$__text['오픈아이디로 글쓰기'] = '';
$__text['오픈아이디로 로그인을 해야만 댓글 및 방명록을 쓸 수 있습니다.'] = 'コメント作成のためにはOpenIDサインインを必要とします。';
$__text['오픈아이디로 로그인하여 쓴 댓글/방명록에 오픈아이디 아이콘을 표시합니다.'] = 'OpenIDで作成したコメントにOpenIDアイコンを表示します。';
...
$__text['원하시는 스킨의 적용 버튼을 클릭하십시오.'] = '利用するスキンを選択してから「適用」ボタンをクリックしてください。';
$__text['월요일'] = '月';
...
$__text['이 블로그가 사용중인 첨부파일의 총 용량은 %1 입니다.'] = '総使用量 %1';
//$__text['이 블로그는 대표 블로그 입니다.'] = '';
$__text['이 블로그에는 총 %1개의 글이 있습니다.'] = '総 %1件の記事';
$__text['이 블로그에는 총 %1개의 코멘트가 있습니다.'] = '総 %1件のコメント';
$__text['이 블로그에는 총 %1개의 트랙백이 있습니다.'] = '総 %1件のトラックバック';
//$__text['이 사용자는 소유자 입니다.'] = '';
$__text['이 사용자를 팀블로그에서 제외합니다.'] = '選択メンバーをチームブログから除名します。';
$__text['이 사이드바 모듈을 삭제합니다.'] = 'モジュール表示解除';
...
$__text['이 표지 모듈을 삭제합니다.'] = 'モジュール表示解除';
...
$__text['이 플러그인은 사용 중지 상태입니다. 클릭하시면 사용을 시작합니다.'] = '利用していないプラグインです。クリックすると利用中に転換します。';
$__text['이 플러그인은 사용중입니다. 클릭하시면 사용을 중지합니다.'] = '利用中のプラグインです。クリックすると利用中止に転換します。';
$__text['이 플러그인은 사용중지 상태입니다. 클릭하시면 사용을 시작합니다.'] = '利用していないプラグインです。クリックすると利用中に転換します。';
...
$__text['이 피드 정보를 수정합니다.'] = 'RSSフィード情報編集';
$__text['이 피드를 갱신 합니다.'] = 'RSSフィード更新';
$__text['이 피드의 원본 사이트를 새 창으로 엽니다.'] = 'RSSフィードの原文ページへ進む';
...
$__text['지정된 이메일로 로그인 정보가 전달되었습니다.'] = '設定したメールへサインイン情報を転送しました。';
...
$__text['추가 가능한 모듈(스킨 기본)'] = '利用可能モジュール(スキンデフォルト)';
...
$__text['취소'] = 'キャンセル';
$__text['취소하기'] = 'キャンセル';
$__text['친구 관계를 설정합니다'] = '詳細情報設定';
$__text['친구 링크 관리'] = '詳細情報設定';
...
$__text['텍스트큐브 글목록에서 발행버튼을 누르거나 글쓰기시 공개범위를 "발행"으로 체크하면 됩니다.'] = '記事一覧から発行にチェックするか記事作成時に公開範囲を発行にしてください。';
...
$__text['텍스트큐브 홈페이지의 %1을 방문하시면 다양한 스킨을 다운로드 하실 수 있습니다. 일반적으로 스킨 파일을 텍스트큐브의 skin 디렉토리로 업로드하면 설치가 완료됩니다. 업로드가 완료된 스킨은 이 메뉴에서 적용 버튼을 눌러 사용하실 수 있습니다.'] = 'Textcube公式サイトの %1からTextcube用のスキンをダウンロードできます。インストールしたスキンの利用のため適用ボタンをクリックしてください。';
...
$__text['토요일'] = '土';
$__text['트랙백 불러오기 속도를 개선하기 위하여 트랙백 테이블의 인덱스 설정을 변경합니다.'] = 'トラックバック動作速の改善のためトラックバックテーブルのインデックス設定を更新します。';
...
//$__text['팀원 추가'] = '';
$__text['팀원 추가에 실패했습니다.'] = 'メンバー作成に失敗しました。';
$__text['파비콘'] = 'Favicon';
...
$__text['판번호'] = 'Version';
$__text['팟캐스트 지정'] = 'PodCastで設定';
$__text['팟캐스트 포스트입니다.'] = 'PodCast用の記事です。';
$__text['팟캐스트'] = 'PodCast';
$__text['팟캐스트로 지정합니다.'] = 'PodCastに設定します。';
...
$__text['플러그인'] = 'プラグイン';
$__text['플러그인은 텍스트큐브의 기능을 확장합니다. 이 곳에서 설치된 플러그인의 사용 여부를 결정할 수 있습니다.'] = 'プラグインでTextcubeの機能追加ができます。ここからインストールされたプラグインの利用可否を設定します。';
$__text['플러그인을 구하려면'] = 'プラグインの求め方';
$__text['플러그인을 비활성화하지 못하였습니다.'] = 'プラグインを利用中止に転換できません。';
$__text['플러그인을 켜거나 끕니다'] = 'プラグイン設定';
$__text['플러그인을 활성화하는데 실패했습니다.'] = 'プラグインを利用中に転換できません。';
$__text['플러그인이 생성한 테이블입니다'] = '設置されたプラグインが作成したテーブル一覧';
$__text['플러그인이 생성한 테이블입니다. 테이블의 데이터를 삭제할 수 있습니다.'] = '設置されたプラグインが作成したデータテーブルです。ここからテーブルのデータを削除できます。';
$__text['피드 갱신'] = 'RSSフィード更新';
$__text['피드 그룹'] = 'RSSフィードグループ';
$__text['피드 등록하기'] = 'RSSフィード追加';
$__text['피드 리스트'] = 'RSSフィード一覧';
$__text['피드 목록'] = 'RSSフィード一覧';
...
$__text['해당 테이블을 정말 삭제하시겠습니까? 사용중인 플러그인은 자동으로 해제됩니다.'] = '選択したテーブルを削除します、よろしいですか？ 利用中のプラグインは利用中止に転換します。';
$__text['허용 시 문제가 발생할 수 있습니다.'] = '許可するとエラーが発生する可能性があります。';
$__text['허용'] = '許可';
$__text['현재 공개 상태입니다.'] = '公開記事';
$__text['현재 그룹 내의 피드 목록'] = 'グループ中のRSSフィード一覧';
//$__text['현재 단일 블로그 모드 텍스트 큐브가 설정되어 있습니다. 단일 블로그 모드에서는 대표 블로그 만이 외부에 보여집니다.'] = '';
...
$__text['휴지통 비우기'] = '全件削除';
$__text['휴지통'] = 'コミ箱';
$__text['휴지통에 버려진 걸린글은 15일이 지나면 자동으로 지워집니다. 광고 걸린글의 차단 및 분석을 위하여 휴지통의 데이터를 사용하는 플러그인이 있을 수 있으므로 수동으로 지우지 않는 것을 권장합니다.'] = 'コミ箱へ移動されたトラックバックは15日後に自動で削除されます。迷惑コメントのブロックと分析のため、或はコミ箱のデータを利用するプラグインのため直接に削除しないようにしてください。';
$__text['휴지통에 버려진 댓글은 15일이 지나면 자동으로 지워집니다. 광고 댓글의 차단 및 분석을 위하여 휴지통의 데이터를 사용하는 플러그인이 있을 수 있으므로 수동으로 지우지 않는 것을 권장합니다.'] = 'コミ箱へ移動されたコメントは15日後に自動で削除されます。迷惑コメントのブロックと分析のため、或はコミ箱のデータを利用するプラグインのため直接に削除しないようにしてください。';
