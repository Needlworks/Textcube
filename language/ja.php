...
$__text["임시 암호가 설정되어 있습니다."] = '臨時パスワードが設定されています。';
//$__text["접속 성공"] = "";
//$__text["접속 실패"] = "";
//$__text["첨부"] = "";
//$__text["총 %d개의 메시지"] = "";
$__text["팀원 추가"] = '新規メンバー作成';
$__text["편집기에 미리 정한 분류로 글을 보내는 기능이 없거나, 글들을 일괄적으로 하나의 분류로 작성하고자 할 때 이 도우미를 사용해서 주소를 만든 후 복사해서 사용하시기 바랍니다."] = 'エディターから分類設定に対応していない時、または記事の分類を一括的で設定しようとするとマネジャーからAPIアドレスを作成してご利用ください。';
...
$__text['%1 : 플러그인이 활성화되어 있지 않아 설정을 저장하지 못했습니다.'] = '%1 : 利用中のプラグインではないので設定保存に失敗しました。';
...
//$__text['%1/entry/'] = '';
$__text['%1개의 피드를 가져왔습니다.\n피드를 업데이트 해 주십시오.'] = '%1 つのフィードを読み込みました。\\nフィードを更新してください。';
...
$__text['RSS 주소를 입력해서 링크할 홈페이지의 정보를 읽어올 수 있습니다. 수동으로 제목과 주소를 입력하셔도 됩니다. RSS 주소를 입력해서 홈페이지의 정보를 읽어온 경우 링크를 추가할 때 바깥 글 읽기에 RSS 주소를 추가할지를 물어봅니다.'] = 'RSSフィードアドレスを入力してブックマーク対象ページの情報の取得ができます。直接入力でもブックマークはできますが、RSS情報取得でブックマークする場合には、作成後にRSSフィードへの登録可否を尋ねます。';
...
$__text['개발자'] = '開発者';
$__text['개수'] = '数';
$__text['개의 피드를 가져왔습니다.\n피드를 업데이트 해 주십시오.'] = '件のフィードを取り込みました。\\nフィードを更新してください。';
$__text['개인 정보'] = '個人情報';
...
$__text['공헌자'] = '貢献者';
$__text['관계 없음'] = '無関係';
$__text['관련글에 글을 겁니다.'] = 'トラックバック転送';
$__text['관련된 글에 글을 겁니다.'] = 'トラックバック転送';
...
$__text['관리자 패널 스킨 선택'] = '管理者テーマ設定';
$__text['관리자 패널 스킨은 로그인한 후 보여지는 패널의 디자인을 다양하게 변경합니다. 관리자 패널 스킨을 추가하기 위해서는 관리자 패널 스킨을 내려받아 /style/admin 디렉토리에 설치하시면 됩니다.'] = '管理者テーマは管理者インターフェースをデザインを設定します。新規管理者テーマのインストールのためには新しいテーマを /style/admin にアップロードしてください。';
$__text['관리자 패널의 스킨을 설정합니다'] = '管理者テーマ設定';
...
$__text['글 작성'] = '記事作成';
$__text['글 작성시 태그나 지역로그를 입력할 때 이올린 서버로부터 자동 추천 단어를 받아 옵니다.'] = 'タグや地域ログの入力時イオリンサーバーからの推薦タグを表示';
...
$__text['댓글, 걸린글, 리퍼러가 입력될 때 아래의 단어가 포함되어 있으면 알림창을 띄우고 휴지통으로 보냅니다.'] = 'コメント、トラックバック、リファラがの入力時に下の単語を含めるとポップアップメッセージを出力してごみ箱へ転送します。';
...
$__text['모듈'] = 'モジュール';
$__text['모듈을 비활성화하지 못하였습니다.'] = 'モジュール解除に転換できません。';
$__text['모든 글'] = '全体記事';
...
$__text['블로그 로그인을 위한 임시 암호가 생성 되었습니다. 이 이메일에 로그인할 수 있는 인증 정보가 포함되어 있습니다.'] = 'サインイン用の臨時パスワードが作成されました。このメールはサインイン認証情報を含めております。';
...
$__text['블로그 이미지 및 아이콘을 설정합니다'] = '個人画像・Favicon設定';
...
$__text['블로그에 다양한 기능을 더해보세요. 원하는 기능이 든 아이콘을 눌러주면 바로 블로그의 기능이 업그레이드 됩니다.'] = 'プラグインでTextcubeの機能追加ができます。ここからインストールされたプラグインの利用可否を設定します。';
...
$__text['센터 플러그인은 로그인후 보이는 관리자 패널에 위젯을 추가해 줍니다.'] = 'ウィジェットは管理者パネルから利用するプラグインのことです。';
$__text['센터 플러그인이나 표지 플러그인은 사이드바와 같이 자유롭게 끌어서 위치를 바꿀 수 있습니다.'] = 'ウィジェットやメタページプラグインはサイドバーのような位置設定ができます。';
$__text['센터'] = 'スタート';
...
$__text['소통 기록'] = 'コメント・トラックバック';
$__text['소통'] = '送受信履歴・ブックマーク';
...
$__text['수정하기'] = '編集';
$__text['수정한 파일은 내려받기 링크를 통해 다운로드 할 수 있습니다. 가장 최근에 수정한 파일을 내려 받기 위해서는 다운로드 전에 꼭 저장을 먼저 해 주시기 바랍니다. 스킨 파일은 하나의 html 파일로 되어 있기 때문에 다양한 웹 에디터를 사용해서 편집하셔도 문제가 없습니다. 내려받은 파일을 웹 에디터로 편집하신 후에 스킨 편집창에 붙여넣는 식으로 스킨을 수정하셔도 됩니다.'] = '編集テーマはダウンロードをクリックしてダウンロードができます。最新版本のダウンロードのためには必ず更新事項を保存してください。テーマファイルは1つのhtmlファイルで構成しており、このファイルはDreamweaverなどのエディターからの編集ができます。';
...
$__text['여기서 지정한 링크들의 관계는 XFN (XHTML Friends Network) 규격에 맞추어 블로그의 링크 출력시 추가 데이터로 함께 출력됩니다.'] = 'ここから設定した情報はXFN (XHTML Friends Network) として適用されます。';
...
$__text['이 곳에서 스킨을 편집할 수 있습니다. 편집이 끝난 스킨은 저장하기를 눌러 반영할 수 있습니다. 수정 중 원래 스킨으로 되돌리고 싶을 때는 되돌리기 버튼을 눌러 원래대로 되돌릴 수 있습니다.'] = 'テーマの編集ができます。編集後、テーマの更新のために必ず更新事項を保存してください。更新事項を保存せず元に戻したいなら「キャンセル」をクリックしてください。';
...
$__text['이 카테고리 이름을 수정합니다. 같은 카테고리의 모든 링크의 카테고리 이름이 함께 바뀝니다.'] = '選択分類の名称を更新します。同分類の記事から分類名が更新されます。';
$__text['이 카테고리 정보는 수정할 수 없습니다.'] = '選択分類は情報の更新が禁じられております。';
...
//$__text['이미지 에디터'] = '';
$__text['이올린 태그 추천 사용'] = 'イオリンタグ推薦設定';
$__text['이올린'] = 'イオリン';
...
$__text['임시 암호 발급에 실패하였습니다.'] = '臨時パスワードの設定に失敗しました。';
$__text['임시 암호 설정'] = '臨時パスワード設定';
$__text['임시 암호'] = '臨時パスワード';
$__text['임시 암호가 설정되었습니다.'] = '臨時パスワードの設定に成功しました。';
$__text['임시 암호가 설정되지 못했습니다.'] = '臨時パスワードの設定に失敗しました。';
...
//$__text['팀블로그'] = '';
$__text['팀블로그의 관리자 패널 스킨을 변경할 경우 다른 팀원들의 관리자 패널 디자인도 함께 바뀝니다.'] = '管理者テーマの変更時、他メンバーのテーマ設定も更新されます。';
$__text['팀원 제외'] = 'メンバー除名';
$__text['팀원 추가'] = '新規メンバー作成';
...
$__text['표지 플러그인은 블로그의 첫 화면이나 표지 화면에 출력되는 위젯을 추가해 줍니다.'] = 'メタページプラグインはブログのメタページから表示されるウィジェットを追加します。';
$__text['표지'] = 'メタページ';
...
$__text['필명 스타일'] = '名前タイプ';
$__text['필명'] = '名前';
$__text['필명을 사칭하는 경우를 방지할 수 있습니다.'] = '名前の詐称を防止します。';
$__text['필자'] = '投稿者';
$__text['필진 목록'] = 'チームブログ';
...
$__text['휴지통 내의 모든 댓글을 삭제합니다. 계속 하시겠습니까?'] = 'ごみ箱中のコメントを全件削除します、よろしいですか？';
$__text['휴지통 비우기'] = '全件削除';
