...
$__text['외부 블로그에 표시되는 메세지의 언어를 설정합니다.<br />달력이나 댓글 입력창에 적용됩니다. 한국어 블로그를 운영하고 계신다면 한국어를 선택해 주십시오.'] = 'ブログの言語設定をします。<br />テーマのカレンダーやコメント入力ウィンドウに適用されます。日本語でブログを利用したいなら日本語をご選択ください。';
$__text['외부 주소'] = 'URL入力';
