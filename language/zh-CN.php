...
$__text['걸린 글 보기'] = '察看引用文章';
$__text['걸린 글이 없습니다'] = '尚无引用文章';
$__text['걸린글'] = '文章引用';
$__text['검색'] = '搜索';
$__text['경과'] = '经过';
$__text['계속보관'] = '永久保管';
...
$__text['글'] = '文章';
$__text['글걸기 시도'] = '试图引用';
$__text['글걸기 전송에 실패하였습니다.'] = '发送引用失败';
$__text['글걸기 주소'] = '文章引用地址';
$__text['글걸기 테이블에 광고 및 스팸 분류를 위한 휴지통 필드를 추가합니다.'] = '在引用文章数据库中添加防止广告和垃圾引用的回收站数据表.';
$__text['글걸기 테이블의 미사용 필드를 삭제합니다.'] = '删除引用文章数据库中未使用数据表';
$__text['글걸기 테이블의 인덱스를 수정합니다.'] = '修改引用文章数据库属性';
$__text['글걸기'] = '文章引用';
...
$__text['지정하신 관련글(글걸기) 로그를 삭제하시겠습니까?'] = '要删除指定的引用吗?';
...
$__text['휴지통'] = '回收站';
$__text['휴지통에 버려진 글걸기는 15일이 지나면 자동으로 지워집니다. 광고 글걸기의 차단 및 분석을 위하여 휴지통의 데이터를 사용하는 플러그인이 있을 수 있으므로 수동으로 지우지 않는 것을 권장합니다.'] = '回收站内的引用在过15天后就会被自动删除. <br />因为有些插件会分析回收站内数据来过滤广告引用，建议不要手动删除.';
