...
$__text['블로그 설정 테이블과 사용자 설정 테이블의 구조를 변경합니다.'] = '变更网志设定数据表和用户设定数据表的结构。';
$__text['블로그 설정 테이블에 RSS 공개 정도 설정 필드를 추가합니다.'] = '为网志设定数据库中添加RSS公开程度数据表.';
$__text['블로그 설정 테이블의 시간대 필드 속성을 변경합니다.'] = '更改网志设定数据库中的时区数据表属性.';
$__text['블로그 설정 테이블의 언어 필드 속성을 변경합니다.'] = '更改网志设定数据库中的语言数据表属性.';
...
$__text['설정 테이블에 블로그 언어 설정을 위한 필드를 추가합니다.'] = '为网志设定数据库添加网志语言设定相关数据表.';
$__text['설정 파일'] = '设定文件';
...
$__text['팀블로그 기능을 위한 테이블을 추가합니다.'] = '为团队网志，增加数据表';
//$__text['팀블로그 멤버 목록'] = '';
$__text['팀블로그 정보를 설정합니다'] = '设定团队网志信息';
$__text['팀블로그 제외'] = '排除于团队网志';
//$__text['팀블로그 참여자를 추가하였습니다.'] = '';
$__text['팀블로그 테이블의 사용자 이름 필드를 삭제합니다.'] = '删除团队网志数据表中的用户名字字段。';
$__text['팀블로그 테이블의 소유 관계를 정의합니다.'] = '定义团队网志数据表中的网志所有关系';
$__text['팀블로그 테이블의 유저 출력 설정 필드를 삭제합니다.'] = '删除团队网志数据表中的设定用户显示字段。';
$__text['팀블로그 테이블의 필드 이름을 변경합니다.'] = '变更团队网志数据表中的字段名';
$__text['팀블로그'] = '团队网志';
