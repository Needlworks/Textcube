...
$__text['관리자의 설정에 의해 오픈아이디로 로그인한 사용자만 댓글을 남길 수 있습니다'] = '按照管理者的设定，只有使用OpenID登入的用户才可以写评论。';
$__text['관리자의 설정에 의해 오픈아이디로 로그인한 사용자만 댓글을 남길 수 있습니다.\r\n로그인하시겠습니까?'] = '按照管理者的设定，只有使用OpenID登入的用户才可以写评论。\r\n要登入吗?';
...
$__text['다른 사람의 블로그에 단 댓글에 대한 댓글이 등록되면 알려줍니다. 알리미가 동작하기 위해서는 댓글 작성시 홈페이지 기입란에 자신의 블로그 주소(<samp>%1</samp>)를 입력하셔야 합니다.'] = '在其他人网志里的留言有回复时会在这里通知您，要使用这个功能在留言时要填写您的网志地址:<samp>%1</samp><br />&nbsp;<br />';
...
$__text['다음'] = '继续';
$__text['다중 사용자 모드로 설치된 경우 블로그 관리자는 메타 페이지 기능을 이용하여 대표 블로그를 다른 블로그들에 대한 센터 기능을 하는 메타 페이지로 구성할 수 있습니다.'] = '安装多用户模式时，网志管理者可以通过MetaPage功能，建立团体网志成员的Metapage。';
$__text['다중 사용자'] = '多用户';
$__text['단일 블로그'] = '单一用户';
$__text['단일 사용자'] = '单一使用者';
$__text['단축키'] = '热键';
...
$__text['메타 페이지 플러그인'] = 'Metapage插件';
$__text['메타 페이지로 바로가기'] = '转到Metapage';
$__text['메타 페이지를 관리합니다'] = '管理Metapage';
$__text['메타 페이지를 첫 화면으로 설정합니다'] = 'Metapage设定为主页';
$__text['메타 페이지의 기능을 스킨 설정 상태로 초기화합니다.'] = '按照模板设定初始化Metapage';
$__text['메타 페이지의 위치는 스킨의 구조에 따라 달라집니다.'] = 'Metapage的位置会因模板结构而不同';
...
$__text['블로그 주소'] = '网志地址';
$__text['블로그 주소(%s)를 관리자로 등록된 오픈아이디 중 하나에 위임하여 오픈아이디로 사용할 수 있습니다.'] = '在以管理员登录的OpenID可以把网志地址委任为自己的OpenID地址来使用。';
...
$__text['블로그의 메타 페이지 구성을 변경할 수 있습니다. 메타 페이지는 블로그 첫 화면에 표시되는 부분입니다. 메타 페이지에 새로운 요소를 추가/삭제할 수 있으며 패널들을 자유롭게 배치 할 수 있습니다.'] = '您可以变更网志的Metapage结构。Metapage是自定义显示网志主页的功能，通过Metapage增加删除要素。';
...
$__text['삭제'] = '删除';
$__text['삭제: 오픈아이디에 부과된 관리자 권한을 제거합니다.'] = '删除:解除与OpenID关联的管理员权限。';
...
$__text['선택된 모듈을 메타 페이지에 추가합니다.'] = '在Metapage增加该模块';
...
$__text['시간대'] = '时区';
$__text['식별자'] = '识别ID';
$__text['실제 블로그 메타 페이지에 사용되는 태그를 직접사용하는 모드입니다.'] = '直接使用网志Metapage里的Tag的模式';
...
$__text['이 메타 페이지 모듈을 삭제합니다.'] = '删除此Metapage模块';
$__text['이 메타 페이지 모듈을 아래로 이동합니다.'] = '向下移动此Metapage模块';
$__text['이 메타 페이지 모듈을 위로 이동합니다.'] = '向上移动此Metapage模块';
...
$__text['정말 메타 페이지의 기능을 초기화하시겠습니까?'] = '确定要初始化Metapage吗？';
