...
$__text['갱신'] = '更新';
$__text['거부'] = '拒绝';
$__text['걸린 글 데이터를 교정하고 있습니다.'] = '正在矫正引用文章数据';
$__text['걸린 글 보기'] = '浏览引用文章';
$__text['걸린 글이 없습니다'] = '无引用文章';
...
$__text['검색'] = '搜索';
$__text['검색엔진이 태그를 따로 인식할 수 있도록 글의 태그에 rel=tag 를 표시합니다. 태그 상자에는 적용되지 않습니다.'] = '为了让搜索引擎独立索引标签,在文章的标签中加入 rel=tag.本功能不适用于标签列表中.';
$__text['경과'] = '经过';
$__text['계속보관'] = '永久保管';
$__text['계정 정보'] = '帐户信息';
$__text['공개 범위'] = '公开范围';
...
$__text['글걸기 테이블에 필터 인덱스를 추가합니다.'] = '引用文章数据表中添加过滤属性.';
$__text['글걸기'] = '文章引用';
...
$__text['댓글 테이블에 필터 인덱스를 추가합니다.'] = '回复数据表中添加过滤属性';
$__text['댓글'] = '回复';
...
$__text['복원'] = '复原';
$__text['복원하기'] = '复原';
$__text['본문 테이블에 태그 검색 향상을 위한 인덱스를 추가합니다.'] = '正文数据表中添加标签搜索优化相关属性';
$__text['본문 필터링'] = '内容过滤';
$__text['본문'] = '正文';
...
$__text['전체보기'] = '查看全部';
$__text['절대 주소'] = '固定地址';
$__text['점검 없이 이 기능을 사용할 수 없습니다.'] = '系统检查前不能使用此功能.';
$__text['정렬'] = '排列';
$__text['정렬방법'] = '排列方式';
