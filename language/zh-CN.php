...
$__text['갱신'] = '更新';
$__text['거부'] = '拒绝';
$__text['걸린 글 데이터를 교정하고 있습니다.'] = '矫正引用文章相关数据库';
$__text['걸린 글 목록입니다'] = '引用文章列表';
//$__text['걸린 글 보기'] = '';
//$__text['걸린 글이 없습니다'] = '';
$__text['걸린글'] = '文章引用';
$__text['검색'] = '搜索';
...
$__text['공헌자'] = '贡献者';
//$__text['관련글에 글을 겁니다.'] = '';
$__text['관련글에 트랙백을 보냅니다.'] = '向相关文章发送引用传送';
...
$__text['글걸기'] = '文章引用';
$__text['글걸기를 기본으로 펼칩니다.'] = '默认展开引用';
$__text['글걸기를 보낸 글을 보여줍니다.'] = '显示发送应用俄文章';
$__text['글걸기를 복원하지 못했습니다.'] = '未能复原引用';
$__text['글걸기를 삭제하지 못했습니다.'] = '未能删除引用';
//$__text['글걸기를 시도합니다'] = '';
$__text['글걸기를 지우지 못했습니다.'] = '未能删除引用';
$__text['글걸기를 허용합니다.'] = '允许引用';
...
$__text['글의 걸린 글 정보를 다시 계산해서 저장합니다.'] = '重新计算引用文章数,并保存.';
...
//$__text['다른 메뉴보기'] = '';
$__text['다른 사람의 블로그에 단 댓글에 대한 댓글이 등록되면 알려줍니다. 알리미가 동작하기 위해서는 댓글 작성시 홈페이지 기입란에 자신의 블로그 주소(<samp>%1</samp>)를 입력하셔야 합니다.'] = '在其他人日志里的留言有回复时会在这里通知您，要使用这个功能在留言时要填写您的日志地址:<samp>%1</samp>';
...
$__text['댓글'] = '回复';
$__text['댓글, 글걸기, 리퍼러가 입력될 때 아래의 단어가 포함되어 있으면 알림창을 띄우고 휴지통으로 보냅니다.'] = '在回复和引用文章中包含以下字符将提示,并发送到回收站.';
...
$__text['선택된 글걸기를 복원합니다. 계속 하시겠습니까?'] = '复原选择的引用,继续吗?';
$__text['선택된 글걸기를 삭제합니다. 계속 하시겠습니까?'] = '删除选择的引用,继续吗?';
$__text['선택된 글걸기를 지웁니다. 계속 하시겠습니까?'] = '解除选择的引用,继续吗?';
$__text['선택된 글걸기를 휴지통으로 옮깁니다. 계속 하시겠습니까?'] = '选择的引用将发送到回收站,继续吗?';
...
$__text['이 IP로 등록된 글걸기 목록을 보여줍니다.'] = '显示此IP发送的引用列表.';
$__text['이 IP로 등록된 댓글 목록을 보여줍니다.'] = '显示此IP的回复列表.';
$__text['이 IP로 등록된 트랙백 목록을 보여줍니다.'] = '显示此IP发送的引用列表.';
...
$__text['이 사이트에서 보낸 글걸기 목록을 보여줍니다.'] = '显示发送的引用文章列表.';
...
$__text['이 트랙백을 복원합니다.'] = '复原此引用';
$__text['이 트랙백을 삭제합니다.'] = '删除此引用';
...
$__text['최근 글걸기 길이'] = '最新引用长度';
$__text['최근 글걸기를 %1 글자로 표시합니다.'] = '最新引用显示到 %1 字以内.';
$__text['최근 글을 %1 글자로 표시합니다.'] = '最新文章显示到 %1 字以内.';
$__text['최근 댓글 길이'] = '最新回复长度';
$__text['최근 댓글을 %1 글자로 표시합니다.'] = '最新文章显示到 %1 字以内.';
//$__text['최근글(%1) 수정'] = '';
$__text['최근에 걸린 글걸기를 %1개 보여줍니다.'] = '最新引用显示 %1个';
//$__text['최근에 달린 답글'] = '';
...
$__text['투명전환'] = '透明转换';
$__text['트랙백'] = '引用传送';
$__text['트랙백을 보낸 포스트를 보여줍니다.'] = '显示发送引用的文章';
$__text['트리 속성'] = '属性';
...
$__text['플러그인 이름'] = '插件名称';
$__text['플러그인'] = '插件';
$__text['플러그인은 <a href="http://www.tattertools.com/plugin" onclick="window.open(this.href); return false;" title="태터툴즈 홈페이지에 개설되어 있는 플러그인 업로드 게시판으로 연결합니다.">태터툴즈 홈페이지의 플러그인 게시판</a>에서 구하실 수 있습니다. 일반적으로 플러그인 파일을 태터툴즈의 plugin 디렉토리로 업로드하면 설치가 완료됩니다. 업로드가 완료된 플러그인은 이 메뉴에서 사용중으로 전환하여 사용을 시작합니다. 추천 플러그인에 대한 정보는 <a href="http://plugin.tattertools.com" onclick="window.open(this.href); return false;">태터앤 프렌즈의 플러그인 리뷰</a>를 참고하십시오.'] = '插件可以到 <a href="http://www.tattertools.cn/plugin" onclick="window.open(this.href); return false;" title="连接到Tattertools网站开设的插件列表.">Tattertools插件列表</a>下载. 一般来说插件上传到 plugin 目录就可以使用. 可以在本页面激活上传的插件来使用. 官方推荐插件可以到 <a href="http://plugin.tattertools.com" onclick="window.open(this.href); return false;">TnF推荐插件列表</a>进行确认.';
...
$__text['휴지통'] = '回收站';
$__text['휴지통에 버려진 글걸기는 15일이 지나면 자동으로 지워집니다. 광고 글걸기의 차단 및 분석을 위하여 휴지통의 데이터를 사용하는 플러그인이 있을 수 있으므로 수동으로 지우지 않는 것을 권장합니다.'] = '回收站内的引用在过15天后就会被自动删除. 因为有些插件会分析回收站内数据来过滤广告引用，建议不要手动删除.';
$__text['휴지통에 버려진 댓글은 15일이 지나면 자동으로 지워집니다. 광고 댓글의 차단 및 분석을 위하여 휴지통의 데이터를 사용하는 플러그인이 있을 수 있으므로 수동으로 지우지 않는 것을 권장합니다.'] = '回收站内的回复在过15天后就会被自动删除. 因为有些插件会分析回收站内数据来过滤广告回复，建议不要手动删除.';
?>