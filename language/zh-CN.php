...
$__text['공지를 봅니다'] = '浏览公告';
$__text['공지사항을 가져올 수 없습니다. 잠시 후 다시 시도해 보심시오'] = '无法读取公告信息,请稍后在试';
...
$__text['리더'] = '阅读';
$__text['리샘플러 설명을 변경하지 못했습니다.'] = '未能更改图片缩放';
...
$__text['이미지 리샘플링 기능을 기본으로 사용합니다. 이 기능을 사용시 서버에 많은 부하가 걸릴 수 있으니 주의하시기 바랍니다.'] = '默认使用图片缩放功能，请注意使用此功能会加重服务器负担';
...
$__text['최근에 쓴 글(%1)을 수정합니다'] = '修改最近文章(%1)';
...
$__text['추가 스킨은 <a href="http://www.tattertools.com/skin" onclick="window.open(this.href); return false;" title="태터툴즈 홈페이지에 개설되어 있는 스킨 업로드 게시판으로 연결합니다.">태터툴즈 홈의 스킨 게시판</a>에서 구하실 수 있습니다. 일반적으로 스킨 파일을 태터툴즈의 skin 디렉토리로 업로드하면 설치가 완료됩니다. 업로드가 완료된 스킨은 이 메뉴에서 적용 버튼을 눌러 사용을 시작합니다.'] = '模板可以到 <a href="http://www.tattertools.cn/skin" onclick="window.open(this.href); return false;" title="连接到Tattertools网站开设的模板列表.">Tattertools模板列表</a>下载. 一般来说模板文件上传到 skin 目录就可以使用. 上传后的模板可以在本页面点击<应用>来使用.';
$__text['추가'] = '新增';
$__text['추가하기'] = '新增';
$__text['출력 설정'] = '显示参数设定';
