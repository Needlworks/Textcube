...
$__text['<p>공지사항이 없습니다.</p>'] = '<p>没有任何通知讯息。</p>';
$__text['<p style="border: 1px solid #EEEEEE; height: 75px; padding-top: 45px; text-align: center;">공지사항을 가져올 수 없습니다.<br />잠시 후 다시 시도해 주십시오.</p>'] = '<p style="border: 1px solid #EEEEEE; height: 75px; padding-top: 45px; text-align: center;">无法取得通知讯息列表。<br />请稍候...</p>';
?>