...
$__text['설정'] = '设定';
$__text['상태'] = '状态';
$__text['수정된 스킨을 사용중입니다. 새로운 스킨을 선택하면 수정된 스킨의 내용과 사이드바의 변경점은 모두 지워집니다.\n스킨을 적용하시겠습니까?'] = '正在使用编辑过的模板，若选择新模板原模板的编辑信息和侧栏信息将会消失.\n确定使用新模板吗？'; 
$__text['새로운 스킨을 선택하면 사이드바의 변경점은 모두 지워집니다.\n스킨을 적용하시겠습니까?'] = '若使用新模板原模板的侧栏信息会消失.\n确定使用新模板吗？';
?>