...
//$__text['%Y/%m/%d'] = '';
//$__text['%m/%d'] = '';
$__text['&copy; 2004 - 2008. 모든 저작권은 개발자 및 공헌자에게 있습니다.<br />텍스트큐브는 니들웍스/TNF에서 개발합니다.<br />텍스트큐브와 텍스트큐브 로고는 니들웍스의 상표입니다.'] = '&copy; 2004 - 2008. 所有的著作权由开发者和贡献者所有。<br />Textcube由needlworks/TNF开发。<br />Textcube和Textcube的Logo是needlworks的商标。';
