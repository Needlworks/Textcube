...
$__text['관리자 패널 스킨은 로그인한 후 보여지는 패널의 디자인을 다양하게 변경합니다. 관리자 패널 스킨을 추가하기 위해서는 관리자 패널 스킨을 내려받아 /style/admin 디렉토리에 설치하시면 됩니다.'] = '管理者页面的模板. 登入的使用者可以自行选择使用的模板样式, 且可在 /style/admin 中加入你所要的模板样式.';
$__text['관리자 패널의 스킨을 설정합니다'] = '后端管理样板设定';
...
$__text['선택된 댓글을 복원합니다. 계속 하시겠습니까?'] = '恢复选择的回复,继续吗?';
...
$__text['센터 플러그인'] = '讯息插件';
$__text['센터 플러그인은 로그인후 보이는 관리자 패널에 위젯을 추가해 줍니다.'] = '管理者可以加入插件给予其他的使用者.';
$__text['센터 플러그인이나 표지 플러그인은 사이드바와 같이 자유롭게 끌어서 위치를 바꿀 수 있습니다.'] = '首页插件与模板讯息插件皆可以自由更动位置.';
$__text['센터'] = '讯息';
...
$__text['이 댓글에 댓글을 씁니다.'] = '为此篇回复新增回复';
...
$__text['팀블로그'] = '团队博客';
$__text['팀블로그의 관리자 패널 스킨을 변경할 경우 다른 팀원들의 관리자 패널 디자인도 함께 바뀝니다.'] = '管理者更改模板样式时, 其他的管理者组员将一并被修改.';
$__text['팀원 제외'] = '移除成员';
$__text['팀원 추가'] = '新增成员';
...
$__text['표지 위젯'] = '首页设定';
$__text['표지 플러그인'] = '首页插件';
$__text['표지 플러그인은 블로그의 첫 화면이나 표지 화면에 출력되는 위젯을 추가해 줍니다.'] = '首页插件加入时会以预设的输出画面输出.';
$__text['표지'] = '首页';
