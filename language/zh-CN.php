...
$__text["관리자 권한이 없는 오픈아이디 입니다"] = '写入署名的 OpenID, 不被采用管理员权利。';
$__text["관리자"] = '管理';
$__text["글관리"] = '文章管理';
...
$__text["임시 암호가 설정되어 있습니다."] = '选择设置密码';
//$__text["접속 성공"] = "";
//$__text["접속 실패"] = "";
//$__text["첨부"] = "";
//$__text["총 %d개의 메시지"] = "";
...
//$__text['%Y/%m/%d'] = '';
//$__text['%m/%d'] = '';
$__text['&copy; 2004 - 2008. 모든 저작권은 개발자 및 공헌자에게 있습니다.<br />텍스트큐브는 니들웍스/TNF에서 개발합니다.<br />텍스트큐브와 텍스트큐브 로고는 니들웍스의 상표입니다.'] = '&copy; 2004 - 2008.<br />著作权为贡献者与开发者所用有。<br />Textcube 与 Needlworks/TNF 持续开发。<br />Textcube 商标为 Needlworks 所拥有并使用。';
...
$__text['RSS를 변경할 수 없습니다.'] = 'RSS地址变更失呗。';
...
$__text['검색 시'] = '搜索时';
$__text['검색'] = '搜索';
$__text['검색엔진이 링크 관계를 인식할 수 있도록 링크에 FOAF를 추가합니다.'] = '为了让搜索引擎识别 FOAF,在链结中追加 rel="FOAF"';
$__text['경과'] = '经过';
...
$__text['등록'] = '登入';
$__text['등록되지 않은 소유자 E-mail 입니다.'] = '没有此 E-mail Address';
...
$__text['로고를 변경하지 못했습니다.'] = '为能修改Icon';
...
$__text['백업파일에 비정상적인 글자가 포함된 경우 복원에 실패할 수 있습니다. 비정상적인 글자를 교정하여 복원이 가능하도록 합니다. 이를 사용할 경우 복원에 많은 시간이 소요될 수 있습니다.'] = '备份档中若包含不正常字符时恢复将失败，可以矫正不正常字符来还原数据.如果使用恢复将多需要点时间.';
...
$__text['백업파일을 자신의 하드디스크로부터 직접 선택하여 데이터베이스를 복원합니다. 백업파일의 용량이 업로드 허용용량을 초과하지 않는지 주의하십시오.'] = '上传备份文件来恢复数据,请注意文件大小不要超过空间允许的最大限制';
...
$__text['본문 테이블에 작성자 정보를 위한 필드를 추가합니다.'] = '为了文章数据表的作者讯息，增加字段。';
...
$__text['블로그 아이콘은 댓글과 방명록에서 사용됩니다. 크기는 16×16 이상, 48×48 이하까지 지원합니다.'] = 'Blog Icon使用在回复和留言板内,支持16×16 以上 48×48以下.';
...
$__text['사이드바에 선택된 모듈의 기능을 추가합니다.'] = '为选择的侧栏模块新增功能';
...
$__text['선택된 모듈을 표지에 추가합니다.'] = '将选择的模块新增到首页中';
...
$__text['에디터에서 다중 파일 업로드를 지원하는 플래시 업로더를 사용합니다.'] = '在编辑模式时使用 Flash 的档案上传. 支持多重档案上传.';
...
$__text['태그모드'] = '卷标模式';
$__text['태그상자의 태그 수'] = '卷标模块的卷标数';
$__text['태그상자의 태그를 %1개 표시합니다.'] = '卷标模块中显示 %1个卷标';
...
$__text['표지 위젯'] = '首页设定';
$__text['표지'] = '首页';
$__text['표지는 블로그 첫 화면 또는 %1/cover 에 표시되는 부분입니다.'] = '首页为博客的第一画面或%1/cover';
$__text['표지를 관리합니다'] = '管理首页';
//$__text['표지를 블로그의 첫 화면으로 사용합니다'] = '';
$__text['표지를 첫 화면으로 사용합니다'] = '将设定为首页';
