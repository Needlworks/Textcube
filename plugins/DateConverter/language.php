...
// - 한국어.
$rgDateInformation['korean']['weekday'][0] = '일요일';
$rgDateInformation['korean']['weekday'][1] = '월요일';
$rgDateInformation['korean']['weekday'][2] = '화요일';
$rgDateInformation['korean']['weekday'][3] = '수요일';
$rgDateInformation['korean']['weekday'][4] = '목요일';
$rgDateInformation['korean']['weekday'][5] = '금요일';
$rgDateInformation['korean']['weekday'][6] = '토요일';
...
$rgDateInformation['english']['day ordinal postfix']['11'] = 'th';
$rgDateInformation['english']['day ordinal postfix']['12'] = 'th';
$rgDateInformation['english']['day ordinal postfix']['13'] = 'th';
...
$rgDateInformation['english']['day ordinal postfix']['21'] = 'st';
$rgDateInformation['english']['day ordinal postfix']['22'] = 'nd';
$rgDateInformation['english']['day ordinal postfix']['23'] = 'rd';
...
$rgDateInformation['english']['month']['length'] = 3;
...
$rgDateInformation['english']['weekday']['length'] = 3;
...
// - 일본어.
$rgDateInformation['japanese']['weekday'][0] = '日曜日';
$rgDateInformation['japanese']['weekday'][1] = '月曜日';
$rgDateInformation['japanese']['weekday'][2] = '火曜日';
$rgDateInformation['japanese']['weekday'][3] = '水曜日';
