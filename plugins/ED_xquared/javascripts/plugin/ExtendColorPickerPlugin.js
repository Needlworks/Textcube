 ...
 */
xq.plugin.ExtendColorPickerPlugin = xq.Class(xq.plugin.Base,
	/**
	 * @name xq.plugin.ExtendColorPickerPlugin
	 * @lends xq.plugin.ExtendColorPickerPlugin.prototype
	...
	onAfterLoad: function(xed) {
		...
		{
			var layer = xq.$('extForeColorLayer');
			...
			var forePicker = new jscolor.color(xq.$('extForeColor'), 
			{valueElement:'extForeColorValue', required:false, insertNodeAt:layer});
			forePicker.fromString("39BD4F");
...
var jscolor = {
	dir : '../images/plugin/colorpicker/', // location of jscolor directory (leave empty to autodetect);
...
//			}
		...
		function drawPicker(x, y) {
			...
			posPad = [
				x+THIS.pickerBorder+THIS.pickerFace+THIS.pickerInset+THIS.styleMarginX ,
			...
			{
				THIS.insertNodeAt.appendChild(p.boxB);
			}
		}
